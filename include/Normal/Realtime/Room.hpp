...
namespace Normal::Realtime {
  ...
  class Room : public ::Il2CppObject/*, public ::System::IDisposable*/ {
    ...
    ::Normal::Realtime::Room::ConnectionStateChanged*& dyn_connectionStateChanged();
    // Get instance field reference: private Normal.Realtime.Room/Normal.Realtime.RPCMessageReceived rpcMessageReceived
    ::Normal::Realtime::Room::RPCMessageReceived*& dyn_rpcMessageReceived();
    ...
    ::Normal::Realtime::IRealtimePrefabInstantiateDelegate*& dyn_$prefabInstantiateDelegate$k__BackingField();
