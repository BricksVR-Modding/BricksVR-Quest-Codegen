...
namespace GlobalNamespace {
  ...
  class OVRInput::OVRControllerGamepadMac : public ::GlobalNamespace::OVRInput::OVRControllerBase {
    public:
    // Writing base type padding for base size: 0x101 to desired offset: 0x108
  ...
  #pragma pack(pop)
  static check_size<sizeof(OVRInput::OVRControllerGamepadMac), 264 + sizeof(bool)> __GlobalNamespace_OVRInput_OVRControllerGamepadMacSizeCheck;
  static_assert(sizeof(OVRInput::OVRControllerGamepadMac) == 0x109);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
