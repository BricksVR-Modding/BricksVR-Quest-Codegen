...
namespace GlobalNamespace {
  ...
  class DestroyBuggedHeldBricks : public ::UnityEngine::MonoBehaviour {
    ...
    ::UnityEngine::XR::Interaction::Toolkit::XRInteractionManager*& dyn__interactionManager();
    // Get instance field reference: public UnityEngine.XR.Interaction.Toolkit.XRDirectInteractor leftHand
    ::UnityEngine::XR::Interaction::Toolkit::XRDirectInteractor*& dyn_leftHand();
    // Get instance field reference: public UnityEngine.XR.Interaction.Toolkit.XRDirectInteractor rightHand
    ::UnityEngine::XR::Interaction::Toolkit::XRDirectInteractor*& dyn_rightHand();
    ...
    ::System::Collections::Generic::List_1<::UnityEngine::XR::Interaction::Toolkit::XRBaseInteractable*>*& dyn_interactablesToCheck();
