...
namespace UnityEngine {
  ...
  // [StaticAccessorAttribute] Offset: 703D34
  // [NativeHeaderAttribute] Offset: 703D34
  // [NativeHeaderAttribute] Offset: 703D34
  // [NativeHeaderAttribute] Offset: 703D34
  class Physics2D : public ::Il2CppObject {
    ...
    // static public System.Int32 RaycastNonAlloc(UnityEngine.Vector2 origin, UnityEngine.Vector2 direction, UnityEngine.RaycastHit2D[] results, System.Single distance)
    // Offset: 0x1046080
    static int RaycastNonAlloc(::UnityEngine::Vector2 origin, ::UnityEngine::Vector2 direction, ::ArrayW<::UnityEngine::RaycastHit2D> results, float distance);
...
// Writing MetadataGetter for method: UnityEngine::Physics2D::RaycastNonAlloc
// Il2CppName: RaycastNonAlloc
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int (*)(::UnityEngine::Vector2, ::UnityEngine::Vector2, ::ArrayW<::UnityEngine::RaycastHit2D>, float)>(&UnityEngine::Physics2D::RaycastNonAlloc)> {
  static const MethodInfo* get() {
    static auto* origin = &::il2cpp_utils::GetClassFromName("UnityEngine", "Vector2")->byval_arg;
    static auto* direction = &::il2cpp_utils::GetClassFromName("UnityEngine", "Vector2")->byval_arg;
    static auto* results = &il2cpp_functions::array_class_get(::il2cpp_utils::GetClassFromName("UnityEngine", "RaycastHit2D"), 1)->byval_arg;
    static auto* distance = &::il2cpp_utils::GetClassFromName("System", "Single")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::Physics2D*), "RaycastNonAlloc", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{origin, direction, results, distance});
  }
};
