...
namespace UnityEngine::UI {
  ...
  class Text : public ::UnityEngine::UI::MaskableGraphic/*, public ::UnityEngine::UI::ILayoutElement*/ {
    ...
    // [TextAreaAttribute] Offset: 0xF0D60
  ...
  #pragma pack(pop)
  static check_size<sizeof(Text), 240 + sizeof(::ArrayW<::UnityEngine::UIVertex>)> __UnityEngine_UI_TextSizeCheck;
  static_assert(sizeof(Text) == 0xF8);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
