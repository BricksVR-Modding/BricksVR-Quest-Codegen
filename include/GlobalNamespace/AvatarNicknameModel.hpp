...
namespace GlobalNamespace {
  ...
  // [RealtimeModelAttribute] Offset: 7284CC
  class AvatarNicknameModel : public ::Normal::Realtime::RealtimeModel {
    ...
    #endif
    #endif
    // [RealtimePropertyAttribute] Offset: 0x729C68
    ...
    // [RealtimePropertyAttribute] Offset: 0x729C84
    ...
    // Field size check
    static_assert(sizeof(::StringW) == 0x8);
    // [RealtimePropertyAttribute] Offset: 0x729CA0
    ...
    // [RealtimePropertyAttribute] Offset: 0x729CBC
    ...
    // Field size check
    static_assert(sizeof(int) == 0x4);
    // [RealtimePropertyAttribute] Offset: 0x729CD8
    ...
    // Field size check
    static_assert(sizeof(int) == 0x4);
    // [RealtimePropertyAttribute] Offset: 0x729CF4
    ...
    ::GlobalNamespace::AvatarNicknameModel::PropertyChangedHandler_1<int>*& dyn_primaryAvatarColorDidChange();
