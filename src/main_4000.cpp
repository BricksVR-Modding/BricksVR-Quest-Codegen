...
[[deprecated("Use field access instead!")]] ::System::Collections::Generic::Dictionary_2<uint, ::TMPro::TMP_GlyphPairAdjustmentRecord*>*& TMPro::TMP_FontFeatureTable::dyn_m_GlyphPairAdjustmentRecordLookupDictionary() {
