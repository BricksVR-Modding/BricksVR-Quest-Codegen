...
[[deprecated]] bool& GlobalNamespace::OVRManager::dyn_enableAdaptiveResolution() {
...
[[deprecated]] bool& GlobalNamespace::OVRManager::dyn_enableColorGamut() {
...
[[deprecated]] ::GlobalNamespace::OVRPlugin::ColorSpace& GlobalNamespace::OVRManager::dyn_colorGamut() {
...
[[deprecated]] bool& GlobalNamespace::OVRManager::dyn_suppressDisableMixedRealityBecauseOfNoMainCameraWarning() {
...
[[deprecated]] bool& GlobalNamespace::OVRManager::dyn_multipleMainCameraWarningPresented() {
...
[[deprecated]] ::UnityEngine::Camera*& GlobalNamespace::OVRManager::dyn_lastFoundMainCamera() {
...
[[deprecated]] int& GlobalNamespace::OVROverlay::dyn_layerId() {
...
// Autogenerated static field getter
// Get static field: static private UnityEngine.Texture2D cachedCameraFrameTexture
::UnityEngine::Texture2D* GlobalNamespace::OVRPlugin::_get_cachedCameraFrameTexture() {
  static auto ___internal__logger = ::Logger::get().WithContext("::GlobalNamespace::OVRPlugin::_get_cachedCameraFrameTexture");
  return THROW_UNLESS(il2cpp_utils::GetFieldValue<::UnityEngine::Texture2D*>("", "OVRPlugin", "cachedCameraFrameTexture"));
}
// Autogenerated static field setter
// Set static field: static private UnityEngine.Texture2D cachedCameraFrameTexture
void GlobalNamespace::OVRPlugin::_set_cachedCameraFrameTexture(::UnityEngine::Texture2D* value) {
  static auto ___internal__logger = ::Logger::get().WithContext("::GlobalNamespace::OVRPlugin::_set_cachedCameraFrameTexture");
  THROW_UNLESS(il2cpp_utils::SetFieldValue("", "OVRPlugin", "cachedCameraFrameTexture", value));
}
// Autogenerated static field getter
// Get static field: static private UnityEngine.Texture2D cachedCameraDepthTexture
::UnityEngine::Texture2D* GlobalNamespace::OVRPlugin::_get_cachedCameraDepthTexture() {
  static auto ___internal__logger = ::Logger::get().WithContext("::GlobalNamespace::OVRPlugin::_get_cachedCameraDepthTexture");
  return THROW_UNLESS(il2cpp_utils::GetFieldValue<::UnityEngine::Texture2D*>("", "OVRPlugin", "cachedCameraDepthTexture"));
}
// Autogenerated static field setter
// Set static field: static private UnityEngine.Texture2D cachedCameraDepthTexture
void GlobalNamespace::OVRPlugin::_set_cachedCameraDepthTexture(::UnityEngine::Texture2D* value) {
  static auto ___internal__logger = ::Logger::get().WithContext("::GlobalNamespace::OVRPlugin::_set_cachedCameraDepthTexture");
  THROW_UNLESS(il2cpp_utils::SetFieldValue("", "OVRPlugin", "cachedCameraDepthTexture", value));
}
// Autogenerated static field getter
// Get static field: static private UnityEngine.Texture2D cachedCameraDepthConfidenceTexture
::UnityEngine::Texture2D* GlobalNamespace::OVRPlugin::_get_cachedCameraDepthConfidenceTexture() {
  static auto ___internal__logger = ::Logger::get().WithContext("::GlobalNamespace::OVRPlugin::_get_cachedCameraDepthConfidenceTexture");
  return THROW_UNLESS(il2cpp_utils::GetFieldValue<::UnityEngine::Texture2D*>("", "OVRPlugin", "cachedCameraDepthConfidenceTexture"));
}
// Autogenerated static field setter
// Set static field: static private UnityEngine.Texture2D cachedCameraDepthConfidenceTexture
void GlobalNamespace::OVRPlugin::_set_cachedCameraDepthConfidenceTexture(::UnityEngine::Texture2D* value) {
  static auto ___internal__logger = ::Logger::get().WithContext("::GlobalNamespace::OVRPlugin::_set_cachedCameraDepthConfidenceTexture");
  THROW_UNLESS(il2cpp_utils::SetFieldValue("", "OVRPlugin", "cachedCameraDepthConfidenceTexture", value));
}
// Autogenerated static field getter
...
// Autogenerated method: OVRPlugin.UpdateCameraDevices
bool GlobalNamespace::OVRPlugin::UpdateCameraDevices() {
  static auto ___internal__logger = ::Logger::get().WithContext("::GlobalNamespace::OVRPlugin::UpdateCameraDevices");
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod("", "OVRPlugin", "UpdateCameraDevices", std::vector<Il2CppClass*>{}, ::std::vector<const Il2CppType*>{})));
  return ::il2cpp_utils::RunMethodRethrow<bool, false>(static_cast<Il2CppObject*>(nullptr), ___internal__method);
}
// Autogenerated method: OVRPlugin.IsCameraDeviceAvailable
bool GlobalNamespace::OVRPlugin::IsCameraDeviceAvailable(::GlobalNamespace::OVRPlugin::CameraDevice cameraDevice) {
  static auto ___internal__logger = ::Logger::get().WithContext("::GlobalNamespace::OVRPlugin::IsCameraDeviceAvailable");
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod("", "OVRPlugin", "IsCameraDeviceAvailable", std::vector<Il2CppClass*>{}, ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractType(cameraDevice)})));
  return ::il2cpp_utils::RunMethodRethrow<bool, false>(static_cast<Il2CppObject*>(nullptr), ___internal__method, cameraDevice);
}
// Autogenerated method: OVRPlugin.SetCameraDevicePreferredColorFrameSize
bool GlobalNamespace::OVRPlugin::SetCameraDevicePreferredColorFrameSize(::GlobalNamespace::OVRPlugin::CameraDevice cameraDevice, int width, int height) {
  static auto ___internal__logger = ::Logger::get().WithContext("::GlobalNamespace::OVRPlugin::SetCameraDevicePreferredColorFrameSize");
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod("", "OVRPlugin", "SetCameraDevicePreferredColorFrameSize", std::vector<Il2CppClass*>{}, ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractType(cameraDevice), ::il2cpp_utils::ExtractType(width), ::il2cpp_utils::ExtractType(height)})));
  return ::il2cpp_utils::RunMethodRethrow<bool, false>(static_cast<Il2CppObject*>(nullptr), ___internal__method, cameraDevice, width, height);
}
// Autogenerated method: OVRPlugin.OpenCameraDevice
bool GlobalNamespace::OVRPlugin::OpenCameraDevice(::GlobalNamespace::OVRPlugin::CameraDevice cameraDevice) {
  static auto ___internal__logger = ::Logger::get().WithContext("::GlobalNamespace::OVRPlugin::OpenCameraDevice");
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod("", "OVRPlugin", "OpenCameraDevice", std::vector<Il2CppClass*>{}, ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractType(cameraDevice)})));
  return ::il2cpp_utils::RunMethodRethrow<bool, false>(static_cast<Il2CppObject*>(nullptr), ___internal__method, cameraDevice);
}
// Autogenerated method: OVRPlugin.CloseCameraDevice
bool GlobalNamespace::OVRPlugin::CloseCameraDevice(::GlobalNamespace::OVRPlugin::CameraDevice cameraDevice) {
  static auto ___internal__logger = ::Logger::get().WithContext("::GlobalNamespace::OVRPlugin::CloseCameraDevice");
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod("", "OVRPlugin", "CloseCameraDevice", std::vector<Il2CppClass*>{}, ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractType(cameraDevice)})));
  return ::il2cpp_utils::RunMethodRethrow<bool, false>(static_cast<Il2CppObject*>(nullptr), ___internal__method, cameraDevice);
}
// Autogenerated method: OVRPlugin.HasCameraDeviceOpened
bool GlobalNamespace::OVRPlugin::HasCameraDeviceOpened(::GlobalNamespace::OVRPlugin::CameraDevice cameraDevice) {
  static auto ___internal__logger = ::Logger::get().WithContext("::GlobalNamespace::OVRPlugin::HasCameraDeviceOpened");
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod("", "OVRPlugin", "HasCameraDeviceOpened", std::vector<Il2CppClass*>{}, ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractType(cameraDevice)})));
  return ::il2cpp_utils::RunMethodRethrow<bool, false>(static_cast<Il2CppObject*>(nullptr), ___internal__method, cameraDevice);
}
// Autogenerated method: OVRPlugin.IsCameraDeviceColorFrameAvailable
bool GlobalNamespace::OVRPlugin::IsCameraDeviceColorFrameAvailable(::GlobalNamespace::OVRPlugin::CameraDevice cameraDevice) {
  static auto ___internal__logger = ::Logger::get().WithContext("::GlobalNamespace::OVRPlugin::IsCameraDeviceColorFrameAvailable");
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod("", "OVRPlugin", "IsCameraDeviceColorFrameAvailable", std::vector<Il2CppClass*>{}, ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractType(cameraDevice)})));
  return ::il2cpp_utils::RunMethodRethrow<bool, false>(static_cast<Il2CppObject*>(nullptr), ___internal__method, cameraDevice);
}
// Autogenerated method: OVRPlugin.GetCameraDeviceColorFrameTexture
::UnityEngine::Texture2D* GlobalNamespace::OVRPlugin::GetCameraDeviceColorFrameTexture(::GlobalNamespace::OVRPlugin::CameraDevice cameraDevice) {
  static auto ___internal__logger = ::Logger::get().WithContext("::GlobalNamespace::OVRPlugin::GetCameraDeviceColorFrameTexture");
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod("", "OVRPlugin", "GetCameraDeviceColorFrameTexture", std::vector<Il2CppClass*>{}, ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractType(cameraDevice)})));
  return ::il2cpp_utils::RunMethodRethrow<::UnityEngine::Texture2D*, false>(static_cast<Il2CppObject*>(nullptr), ___internal__method, cameraDevice);
}
// Autogenerated method: OVRPlugin.DoesCameraDeviceSupportDepth
bool GlobalNamespace::OVRPlugin::DoesCameraDeviceSupportDepth(::GlobalNamespace::OVRPlugin::CameraDevice cameraDevice) {
  static auto ___internal__logger = ::Logger::get().WithContext("::GlobalNamespace::OVRPlugin::DoesCameraDeviceSupportDepth");
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod("", "OVRPlugin", "DoesCameraDeviceSupportDepth", std::vector<Il2CppClass*>{}, ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractType(cameraDevice)})));
  return ::il2cpp_utils::RunMethodRethrow<bool, false>(static_cast<Il2CppObject*>(nullptr), ___internal__method, cameraDevice);
}
// Autogenerated method: OVRPlugin.SetCameraDeviceDepthSensingMode
bool GlobalNamespace::OVRPlugin::SetCameraDeviceDepthSensingMode(::GlobalNamespace::OVRPlugin::CameraDevice camera, ::GlobalNamespace::OVRPlugin::CameraDeviceDepthSensingMode depthSensoringMode) {
  static auto ___internal__logger = ::Logger::get().WithContext("::GlobalNamespace::OVRPlugin::SetCameraDeviceDepthSensingMode");
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod("", "OVRPlugin", "SetCameraDeviceDepthSensingMode", std::vector<Il2CppClass*>{}, ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractType(camera), ::il2cpp_utils::ExtractType(depthSensoringMode)})));
  return ::il2cpp_utils::RunMethodRethrow<bool, false>(static_cast<Il2CppObject*>(nullptr), ___internal__method, camera, depthSensoringMode);
}
// Autogenerated method: OVRPlugin.SetCameraDevicePreferredDepthQuality
bool GlobalNamespace::OVRPlugin::SetCameraDevicePreferredDepthQuality(::GlobalNamespace::OVRPlugin::CameraDevice camera, ::GlobalNamespace::OVRPlugin::CameraDeviceDepthQuality depthQuality) {
  static auto ___internal__logger = ::Logger::get().WithContext("::GlobalNamespace::OVRPlugin::SetCameraDevicePreferredDepthQuality");
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod("", "OVRPlugin", "SetCameraDevicePreferredDepthQuality", std::vector<Il2CppClass*>{}, ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractType(camera), ::il2cpp_utils::ExtractType(depthQuality)})));
  return ::il2cpp_utils::RunMethodRethrow<bool, false>(static_cast<Il2CppObject*>(nullptr), ___internal__method, camera, depthQuality);
}
// Autogenerated method: OVRPlugin.IsCameraDeviceDepthFrameAvailable
bool GlobalNamespace::OVRPlugin::IsCameraDeviceDepthFrameAvailable(::GlobalNamespace::OVRPlugin::CameraDevice cameraDevice) {
  static auto ___internal__logger = ::Logger::get().WithContext("::GlobalNamespace::OVRPlugin::IsCameraDeviceDepthFrameAvailable");
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod("", "OVRPlugin", "IsCameraDeviceDepthFrameAvailable", std::vector<Il2CppClass*>{}, ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractType(cameraDevice)})));
  return ::il2cpp_utils::RunMethodRethrow<bool, false>(static_cast<Il2CppObject*>(nullptr), ___internal__method, cameraDevice);
}
// Autogenerated method: OVRPlugin.GetCameraDeviceDepthFrameTexture
::UnityEngine::Texture2D* GlobalNamespace::OVRPlugin::GetCameraDeviceDepthFrameTexture(::GlobalNamespace::OVRPlugin::CameraDevice cameraDevice) {
  static auto ___internal__logger = ::Logger::get().WithContext("::GlobalNamespace::OVRPlugin::GetCameraDeviceDepthFrameTexture");
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod("", "OVRPlugin", "GetCameraDeviceDepthFrameTexture", std::vector<Il2CppClass*>{}, ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractType(cameraDevice)})));
  return ::il2cpp_utils::RunMethodRethrow<::UnityEngine::Texture2D*, false>(static_cast<Il2CppObject*>(nullptr), ___internal__method, cameraDevice);
}
// Autogenerated method: OVRPlugin.GetCameraDeviceDepthConfidenceTexture
::UnityEngine::Texture2D* GlobalNamespace::OVRPlugin::GetCameraDeviceDepthConfidenceTexture(::GlobalNamespace::OVRPlugin::CameraDevice cameraDevice) {
  static auto ___internal__logger = ::Logger::get().WithContext("::GlobalNamespace::OVRPlugin::GetCameraDeviceDepthConfidenceTexture");
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod("", "OVRPlugin", "GetCameraDeviceDepthConfidenceTexture", std::vector<Il2CppClass*>{}, ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractType(cameraDevice)})));
  return ::il2cpp_utils::RunMethodRethrow<::UnityEngine::Texture2D*, false>(static_cast<Il2CppObject*>(nullptr), ___internal__method, cameraDevice);
}
...
::GlobalNamespace::OVRPlugin::SystemHeadset GlobalNamespace::OVRPlugin::SystemHeadset::_get_Placeholder_9() {
  static auto ___internal__logger = ::Logger::get().WithContext("::GlobalNamespace::OVRPlugin::SystemHeadset::_get_Placeholder_9");
  return THROW_UNLESS(il2cpp_utils::GetFieldValue<::GlobalNamespace::OVRPlugin::SystemHeadset>("", "OVRPlugin/SystemHeadset", "Placeholder_9"));
}
// Autogenerated static field setter
// Set static field: static public OVRPlugin/SystemHeadset Placeholder_9
void GlobalNamespace::OVRPlugin::SystemHeadset::_set_Placeholder_9(::GlobalNamespace::OVRPlugin::SystemHeadset value) {
  static auto ___internal__logger = ::Logger::get().WithContext("::GlobalNamespace::OVRPlugin::SystemHeadset::_set_Placeholder_9");
  THROW_UNLESS(il2cpp_utils::SetFieldValue("", "OVRPlugin/SystemHeadset", "Placeholder_9", value));
}
// Autogenerated static field getter
