...
namespace GlobalNamespace {
  ...
  class TextFPSCounter : public ::UnityEngine::MonoBehaviour {
    ...
    ::TMPro::TextMeshProUGUI*& dyn_textDisplay();
    ...
    ::System::Collections::Generic::Dictionary_2<int, ::StringW>*& dyn__fpsToUIStringMap();
    // Get instance field reference: private System.Collections.Generic.List`1<System.Int32> _last10Times
    ::System::Collections::Generic::List_1<int>*& dyn__last10Times();
