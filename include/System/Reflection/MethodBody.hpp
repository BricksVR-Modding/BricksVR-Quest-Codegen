...
namespace System::Reflection {
  ...
  class MethodBody : public ::Il2CppObject {
    ...
    // Offset: 0x1E1950
    ::ArrayW<uint8_t> GetILAsByteArray();
...
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: System::Reflection::MethodBody::GetILAsByteArray
// Il2CppName: GetILAsByteArray
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayW<uint8_t> (System::Reflection::MethodBody::*)()>(&System::Reflection::MethodBody::GetILAsByteArray)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(System::Reflection::MethodBody*), "GetILAsByteArray", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
