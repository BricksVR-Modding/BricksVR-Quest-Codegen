...
namespace Normal::Realtime::Serialization {
  ...
  class LocalChangeCache_1 : public ::Il2CppObject {
    ...
    ::System::Collections::Generic::Queue_1<typename ::Normal::Realtime::Serialization::LocalChangeCache_1<T>::InflightUpdate>*& dyn__inflightUpdates() {
    ...
    ::System::Func_1<T>*& dyn__initializeLocalCache() {
