...
namespace GlobalNamespace {
  ...
  class TeleportTransitionBlink : public ::GlobalNamespace::TeleportTransition {
    ...
    public:
    // [TooltipAttribute] Offset: 0x102FE0
    // [RangeAttribute] Offset: 0x102FE0
    ...
    // [TooltipAttribute] Offset: 0x1030E0
    // [RangeAttribute] Offset: 0x1030E0
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [TooltipAttribute] Offset: 0x103190
