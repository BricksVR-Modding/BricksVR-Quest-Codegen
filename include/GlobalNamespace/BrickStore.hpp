...
namespace GlobalNamespace {
  ...
  class BrickStore : public ::UnityEngine::MonoBehaviour {
    ...
    // [FormerlySerializedAsAttribute] Offset: 0x729F04
    ...
    ::System::Collections::Generic::Dictionary_2<::StringW, ::UnityEngine::GameObject*>*& dyn__dict();
    // Get instance field reference: public TMPro.TextMeshProUGUI brickCountText
    ::TMPro::TextMeshProUGUI*& dyn_brickCountText();
