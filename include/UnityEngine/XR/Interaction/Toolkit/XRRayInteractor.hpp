...
namespace UnityEngine::XR::Interaction::Toolkit {
  ...
  #pragma pack(pop)
  static check_size<sizeof(XRRayInteractor), 416 + sizeof(::UnityEngine::XR::Interaction::Toolkit::UI::XRUIInputModule*)> __UnityEngine_XR_Interaction_Toolkit_XRRayInteractorSizeCheck;
  static_assert(sizeof(XRRayInteractor) == 0x1A8);
}
#include "beatsaber-hook/shared/utils/il2cpp-type-check.hpp"
