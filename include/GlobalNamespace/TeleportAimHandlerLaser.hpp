...
namespace GlobalNamespace {
  ...
  class TeleportAimHandlerLaser : public ::GlobalNamespace::TeleportAimHandler {
    ...
    #endif
    #endif
    // [TooltipAttribute] Offset: 0x720368
  ...
  #pragma pack(pop)
  static check_size<sizeof(TeleportAimHandlerLaser), 36 + sizeof(float)> __GlobalNamespace_TeleportAimHandlerLaserSizeCheck;
  static_assert(sizeof(TeleportAimHandlerLaser) == 0x28);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
