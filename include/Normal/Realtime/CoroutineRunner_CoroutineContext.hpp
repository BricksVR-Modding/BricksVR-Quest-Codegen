...
namespace Normal::Realtime {
  ...
  class CoroutineRunner::CoroutineContext : public ::Il2CppObject {
    ...
    ::Normal::Realtime::CoroutineRunner::CoroutineContext::State& dyn__state();
    // Get instance field reference: private System.Collections.IEnumerator _coroutineEnumerator
    ::System::Collections::IEnumerator*& dyn__coroutineEnumerator();
    ...
    ::System::Action*& dyn_$cleanupAction$k__BackingField();
