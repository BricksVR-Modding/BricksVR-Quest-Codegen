...
namespace UnityEngine::XR::Interaction::Toolkit {
  ...
  #pragma pack(pop)
  static check_size<sizeof(XRBaseControllerInteractor), 248 + sizeof(::UnityEngine::AudioSource*)> __UnityEngine_XR_Interaction_Toolkit_XRBaseControllerInteractorSizeCheck;
  static_assert(sizeof(XRBaseControllerInteractor) == 0x100);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
