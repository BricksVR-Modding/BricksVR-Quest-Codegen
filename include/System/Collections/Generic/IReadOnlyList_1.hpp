...
namespace System::Collections::Generic {
  ...
  // [DefaultMemberAttribute] Offset: C0520
  // [TypeDependencyAttribute] Offset: C0520
  template<typename T>
  class IReadOnlyList_1/*, public ::System::Collections::Generic::IReadOnlyCollection_1<T>*/ {
    ...
    T get_Item(int index) {
      ...
      auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::ResolveVtableSlot(this, classof(::System::Collections::Generic::IReadOnlyList_1<T>*), -1));
