...
NEED_NO_BOX(::OVRTouchSample::Hand::$$c);
DEFINE_IL2CPP_ARG_TYPE(::OVRTouchSample::Hand::$$c*, "OVRTouchSample", "Hand/<>c");
// Type namespace: OVRTouchSample
namespace OVRTouchSample {
  // Size: 0x10
  #pragma pack(push, 1)
  // Autogenerated type: OVRTouchSample.Hand/OVRTouchSample.<>c
...
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: OVRTouchSample::Hand::$$c::_cctor
// Il2CppName: .cctor
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)()>(&OVRTouchSample::Hand::$$c::_cctor)> {
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (OVRTouchSample::Hand::$$c::*)(::UnityEngine::Collider*)>(&OVRTouchSample::Hand::$$c::$Start$b__36_0)> {
  static const MethodInfo* get() {
    static auto* childCollider = &::il2cpp_utils::GetClassFromName("UnityEngine", "Collider")->byval_arg;
