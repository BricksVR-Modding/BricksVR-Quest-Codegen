...
namespace GlobalNamespace {
  ...
  class OVRVignette : public ::UnityEngine::MonoBehaviour {
    ...
    // [TooltipAttribute] Offset: 0xD0A90
    ...
    // [TooltipAttribute] Offset: 0xD0B90
    ...
    // [TooltipAttribute] Offset: 0xD0C90
    ...
    // [TooltipAttribute] Offset: 0xD0D40
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [TooltipAttribute] Offset: 0xD0DD0
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [ColorUsageAttribute] Offset: 0xD0E60
    // [TooltipAttribute] Offset: 0xD0E60
