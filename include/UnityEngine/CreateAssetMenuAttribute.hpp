...
namespace UnityEngine {
  ...
  // [AttributeUsageAttribute] Offset: 6D8C08
  class CreateAssetMenuAttribute : public ::System::Attribute {
    ...
    #endif
    #endif
    // [DebuggerBrowsableAttribute] Offset: 0x6DC36C
    ...
    // [DebuggerBrowsableAttribute] Offset: 0x6DC3A8
  ...
  #pragma pack(pop)
  static check_size<sizeof(CreateAssetMenuAttribute), 24 + sizeof(int)> __UnityEngine_CreateAssetMenuAttributeSizeCheck;
  static_assert(sizeof(CreateAssetMenuAttribute) == 0x1C);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
