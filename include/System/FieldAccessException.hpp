...
namespace System {
  // Forward declaring type: FieldAccessException
...
namespace System {
  ...
  // [ComVisibleAttribute] Offset: 6C6A64
  class FieldAccessException : public ::System::MemberAccessException {
    ...
    template<::il2cpp_utils::CreationType creationType = ::il2cpp_utils::CreationType::Temporary>
    static FieldAccessException* New_ctor(::StringW message) {
      static auto ___internal__logger = ::Logger::get().WithContext("::System::FieldAccessException::.ctor");
...
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: System::FieldAccessException::New_ctor
// Il2CppName: .ctor
