...
namespace UnityEngine {
  ...
  // [NativeHeaderAttribute] Offset: 103380
  class GUILayoutUtility : public ::Il2CppObject {
    ...
    // static System.Void BeginContainer(UnityEngine.GUILayoutUtility/UnityEngine.LayoutCache cache)
    // Offset: 0x6213C0
    static void BeginContainer(::UnityEngine::GUILayoutUtility::LayoutCache* cache);
    ...
    // Offset: 0x622240
    static void LayoutFromContainer(float w, float h);
...
// Writing MetadataGetter for method: UnityEngine::GUILayoutUtility::BeginContainer
// Il2CppName: BeginContainer
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)(::UnityEngine::GUILayoutUtility::LayoutCache*)>(&UnityEngine::GUILayoutUtility::BeginContainer)> {
  static const MethodInfo* get() {
    static auto* cache = &::il2cpp_utils::GetClassFromName("UnityEngine", "GUILayoutUtility/LayoutCache")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::GUILayoutUtility*), "BeginContainer", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{cache});
  }
};
...
// Writing MetadataGetter for method: UnityEngine::GUILayoutUtility::LayoutFromContainer
// Il2CppName: LayoutFromContainer
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)(float, float)>(&UnityEngine::GUILayoutUtility::LayoutFromContainer)> {
  static const MethodInfo* get() {
    ...
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::GUILayoutUtility*), "LayoutFromContainer", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{w, h});
  }
};
