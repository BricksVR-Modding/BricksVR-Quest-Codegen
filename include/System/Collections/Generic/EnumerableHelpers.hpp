...
namespace System::Collections::Generic {
  ...
  class EnumerableHelpers : public ::Il2CppObject {
    public:
    // static T[] ToArray(System.Collections.Generic.IEnumerable`1<T> source, out System.Int32 length)
    // Offset: 0xFFFFFFFFFFFFFFFF
    template<class T>
    static ::ArrayW<T> ToArray(::System::Collections::Generic::IEnumerable_1<T>* source, ByRef<int> length) {
      static auto ___internal__logger = ::Logger::get().WithContext("::System::Collections::Generic::EnumerableHelpers::ToArray");
      static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod("System.Collections.Generic", "EnumerableHelpers", "ToArray", std::vector<Il2CppClass*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get()}, ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractType(source), ::il2cpp_utils::ExtractIndependentType<int&>()})));
      static auto* ___generic__method = THROW_UNLESS(::il2cpp_utils::MakeGenericMethod(___internal__method, std::vector<Il2CppClass*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get()}));
      return ::il2cpp_utils::RunMethodRethrow<::ArrayW<T>, false>(static_cast<Il2CppObject*>(nullptr), ___generic__method, source, byref(length));
    }
