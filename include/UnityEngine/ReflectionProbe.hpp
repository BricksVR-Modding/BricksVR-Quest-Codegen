...
namespace UnityEngine {
  ...
  // [NativeHeaderAttribute] Offset: 6D7190
  class ReflectionProbe : public ::UnityEngine::Behaviour {
    ...
    // [DebuggerBrowsableAttribute] Offset: 0x6DB85C
    ...
    // [DebuggerBrowsableAttribute] Offset: 0x6DB898
...
// Writing MetadataGetter for method: UnityEngine::ReflectionProbe::get_texture
// Il2CppName: get_texture
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Texture* (UnityEngine::ReflectionProbe::*)()>(&UnityEngine::ReflectionProbe::get_texture)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::ReflectionProbe*), "get_texture", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
