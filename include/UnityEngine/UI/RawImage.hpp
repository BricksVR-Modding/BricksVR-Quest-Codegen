...
namespace UnityEngine::UI {
  ...
  // [AddComponentMenu] Offset: EC560
  class RawImage : public ::UnityEngine::UI::MaskableGraphic {
    public:
    public:
    // [FormerlySerializedAsAttribute] Offset: 0xEC5F0
  ...
  #pragma pack(pop)
  static check_size<sizeof(RawImage), 208 + sizeof(::UnityEngine::Rect)> __UnityEngine_UI_RawImageSizeCheck;
  static_assert(sizeof(RawImage) == 0xE0);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
