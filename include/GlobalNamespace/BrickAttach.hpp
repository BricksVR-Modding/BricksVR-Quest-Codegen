...
namespace GlobalNamespace {
  ...
  class BrickAttach : public ::UnityEngine::MonoBehaviour {
    ...
    ::System::Collections::Generic::Dictionary_2<::StringW, ::GlobalNamespace::LegoConnectorScript*>*& dyn_maleConnectorScriptsByName();
    // Get instance field reference: public UnityEngine.Mesh originalMesh
    ::UnityEngine::Mesh*& dyn_originalMesh();
    // Get instance field reference: public UnityEngine.Material originalMaterial
    ::UnityEngine::Material*& dyn_originalMaterial();
    // Get instance field reference: private BuildingBrickSync _brickSync
    ::GlobalNamespace::BuildingBrickSync*& dyn__brickSync();
    ...
    ::System::Collections::Generic::Dictionary_2<::GlobalNamespace::BrickAttach*, bool>*& dyn__attachBuffer();
