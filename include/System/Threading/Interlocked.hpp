...
// Writing MetadataGetter for method: System::Threading::Interlocked::MemoryBarrier
// Il2CppName: MemoryBarrier
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)()>(&System::Threading::Interlocked::MemoryBarrier)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(System::Threading::Interlocked*), "MemoryBarrier", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
