...
namespace UnityEngine::Experimental::Video {
  ...
  // [NativeHeaderAttribute] Offset: 70FF14
  // [NativeHeaderAttribute] Offset: 70FF14
  // [NativeHeaderAttribute] Offset: 70FF14
  // [NativeHeaderAttribute] Offset: 70FF14
  // [RequiredByNativeCodeAttribute] Offset: 70FF14
  // [StaticAccessorAttribute] Offset: 70FF14
  struct VideoClipPlayable/*, public ::System::ValueType, public ::System::IEquatable_1<::UnityEngine::Experimental::Video::VideoClipPlayable>*/ {
    public:
    public:
