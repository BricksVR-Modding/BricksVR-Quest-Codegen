...
namespace UnityEngine::XR::Management {
  ...
  class XRManagerSettings : public ::UnityEngine::ScriptableObject {
    ...
    // Field size check
    static_assert(sizeof(bool) == 0x1);
    // [TooltipAttribute] Offset: 0x7271E4
    // [FormerlySerializedAsAttribute] Offset: 0x7271E4
    ...
    // Field size check
    static_assert(sizeof(bool) == 0x1);
    // [TooltipAttribute] Offset: 0x727254
    // [FormerlySerializedAsAttribute] Offset: 0x727254
    ...
    char __padding3[0x4] = {};
    // [TooltipAttribute] Offset: 0x7272C4
    // [FormerlySerializedAsAttribute] Offset: 0x7272C4
    ...
    // private System.Boolean CheckLoaderRegistration(UnityEngine.XR.Management.XRLoader loader)
    // Offset: 0x1040B64
    bool CheckLoaderRegistration(::UnityEngine::XR::Management::XRLoader* loader);
...
// Writing MetadataGetter for method: UnityEngine::XR::Management::XRManagerSettings::CheckLoaderRegistration
// Il2CppName: CheckLoaderRegistration
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (UnityEngine::XR::Management::XRManagerSettings::*)(::UnityEngine::XR::Management::XRLoader*)>(&UnityEngine::XR::Management::XRManagerSettings::CheckLoaderRegistration)> {
  static const MethodInfo* get() {
    static auto* loader = &::il2cpp_utils::GetClassFromName("UnityEngine.XR.Management", "XRLoader")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::XR::Management::XRManagerSettings*), "CheckLoaderRegistration", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{loader});
  }
};
