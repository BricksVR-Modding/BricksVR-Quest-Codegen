...
namespace UnityEngine::UI::ProceduralImage {
  ...
  // [AddComponentMenu] Offset: 7286BC
  ...
  #pragma pack(pop)
  static check_size<sizeof(ProceduralImage), 264 + sizeof(float)> __UnityEngine_UI_ProceduralImage_ProceduralImageSizeCheck;
  static_assert(sizeof(ProceduralImage) == 0x10C);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
