...
namespace System::IO {
  ...
  // [ComVisibleAttribute] Offset: 6C8CD4
  class DirectoryInfo : public ::System::IO::FileSystemInfo {
    ...
    // Offset: 0xBD5D54
    ::ArrayW<::System::IO::FileInfo*> GetFiles(::StringW searchPattern);
...
// Il2CppName: GetFiles
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayW<::System::IO::FileInfo*> (System::IO::DirectoryInfo::*)(::StringW)>(&System::IO::DirectoryInfo::GetFiles)> {
  static const MethodInfo* get() {
    static auto* searchPattern = &::il2cpp_utils::GetClassFromName("System", "String")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(System::IO::DirectoryInfo*), "GetFiles", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{searchPattern});
  }
};
