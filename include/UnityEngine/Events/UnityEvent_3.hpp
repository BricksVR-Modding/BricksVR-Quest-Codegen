...
namespace UnityEngine::Events {
  // Forward declaring type: UnityEvent`3<T0, T1, T2>
...
namespace UnityEngine::Events {
  ...
  class UnityEvent_3 : public ::UnityEngine::Events::UnityEventBase {
    ...
    [[deprecated]] ::ArrayW<::Il2CppObject*>& dyn_m_InvokeArray() {
      static auto ___internal__logger = ::Logger::get().WithContext("::UnityEngine::Events::UnityEvent_3::dyn_m_InvokeArray");
    ...
    void Invoke(T0 arg0, T1 arg1, T2 arg2) {
      static auto ___internal__logger = ::Logger::get().WithContext("::UnityEngine::Events::UnityEvent_3::Invoke");
      static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, "Invoke", std::vector<Il2CppClass*>{}, ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractType(arg0), ::il2cpp_utils::ExtractType(arg1), ::il2cpp_utils::ExtractType(arg2)})));
    ...
    static UnityEvent_3<T0, T1, T2>* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("::UnityEngine::Events::UnityEvent_3::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<UnityEvent_3<T0, T1, T2>*, creationType>()));
    }
    ...
    ::System::Reflection::MethodInfo* FindMethod_Impl(::StringW name, ::Il2CppObject* targetObj) {
      static auto ___internal__logger = ::Logger::get().WithContext("::UnityEngine::Events::UnityEvent_3::FindMethod_Impl");
    ...
    ::UnityEngine::Events::BaseInvokableCall* GetDelegate(::Il2CppObject* target, ::System::Reflection::MethodInfo* theFunction) {
      static auto ___internal__logger = ::Logger::get().WithContext("::UnityEngine::Events::UnityEvent_3::GetDelegate");
      auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::ResolveVtableSlot(this, classof(::UnityEngine::Events::UnityEventBase*), -1));
  ...
  // Could not write size check! Type: UnityEngine.Events.UnityEvent`3 is generic, or has no fields that are valid for size checks!
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
