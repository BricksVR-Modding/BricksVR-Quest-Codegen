...
namespace Oculus::Avatar {
  ...
  class CAPI : public ::Il2CppObject {
    ...
    static constexpr const char* LibFile = "libovravatar";
    ...
    static ::System::Version* _get_AvatarSDKVersion();
    // Set static field: static public readonly System.Version AvatarSDKVersion
    static void _set_AvatarSDKVersion(::System::Version* value);
    ...
    // Offset: 0x6FD030
    static void _cctor();
    // static public System.Void ovrAvatar_Initialize(System.String appID)
    // Offset: 0x703560
    static void ovrAvatar_Initialize(::StringW appID);
...
// Writing MetadataGetter for method: Oculus::Avatar::CAPI::ovrAvatar_Initialize
// Il2CppName: ovrAvatar_Initialize
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)(::StringW)>(&Oculus::Avatar::CAPI::ovrAvatar_Initialize)> {
  static const MethodInfo* get() {
    static auto* appID = &::il2cpp_utils::GetClassFromName("System", "String")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(Oculus::Avatar::CAPI*), "ovrAvatar_Initialize", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{appID});
  }
};
