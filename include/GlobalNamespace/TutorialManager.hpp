...
namespace GlobalNamespace {
  ...
  class TutorialManager : public ::UnityEngine::MonoBehaviour {
    ...
    // Field size check
    static_assert(sizeof(::UnityEngine::GameObject*) == 0x8);
    // [HeaderAttribute] Offset: 0x72A69C
    ...
    // Field size check
    static_assert(sizeof(::UnityEngine::GameObject*) == 0x8);
    // [HeaderAttribute] Offset: 0x72A6D4
    ...
    ::UnityEngine::GameObject*& dyn_infoBoard();
    // Get instance field reference: public UnityEngine.GameObject tutorialEnvContents
    ::UnityEngine::GameObject*& dyn_tutorialEnvContents();
    ...
    ::UnityEngine::XR::Interaction::Toolkit::SnapTurnProvider*& dyn_snapTurnProvider();
    // Get instance field reference: public SmoothTurn smoothTurn
    ::GlobalNamespace::SmoothTurn*& dyn_smoothTurn();
    ...
    ::UnityEngine::Renderer*& dyn_loadingObjectRenderer();
    // Get instance field reference: public HandBrickSpawner leftHandBrickSpawner
    ::GlobalNamespace::HandBrickSpawner*& dyn_leftHandBrickSpawner();
    // Get instance field reference: public HandBrickSpawner rightHandBrickSpawner
    ::GlobalNamespace::HandBrickSpawner*& dyn_rightHandBrickSpawner();
    ...
    ::UnityEngine::AudioSource*& dyn_canvasAudioSource();
