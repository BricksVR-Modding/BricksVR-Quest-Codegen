...
namespace UnityEngine::XR::Interaction::Toolkit {
  ...
  struct MatchOrientation/*, public ::System::Enum*/ {
    ...
    // static field const value: static public UnityEngine.XR.Interaction.Toolkit.MatchOrientation Camera
    ...
    static ::UnityEngine::XR::Interaction::Toolkit::MatchOrientation _get_Camera();
    // Set static field: static public UnityEngine.XR.Interaction.Toolkit.MatchOrientation Camera
    static void _set_Camera(::UnityEngine::XR::Interaction::Toolkit::MatchOrientation value);
