...
namespace Normal::Realtime {
  ...
  class TimelineEntry_1 : public ::Il2CppObject {
    ...
    [[deprecated("Use field access instead!")]] ::Normal::Realtime::TimelineEntry_1<T>*& dyn_$prev$k__BackingField() {
    ...
    [[deprecated("Use field access instead!")]] ::Normal::Realtime::TimelineEntry_1<T>*& dyn_$next$k__BackingField() {
