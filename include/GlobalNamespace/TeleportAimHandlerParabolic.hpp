...
namespace GlobalNamespace {
  ...
  class TeleportAimHandlerParabolic : public ::GlobalNamespace::TeleportAimHandler {
    ...
    // [TooltipAttribute] Offset: 0xFFA30
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [TooltipAttribute] Offset: 0xFFA60
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [TooltipAttribute] Offset: 0xFFA90
    // [RangeAttribute] Offset: 0xFFA90
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [TooltipAttribute] Offset: 0xFFB50
    // [RangeAttribute] Offset: 0xFFB50
  ...
  #pragma pack(pop)
  static check_size<sizeof(TeleportAimHandlerParabolic), 56 + sizeof(float)> __GlobalNamespace_TeleportAimHandlerParabolicSizeCheck;
  static_assert(sizeof(TeleportAimHandlerParabolic) == 0x3C);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
