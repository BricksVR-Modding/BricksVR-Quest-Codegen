...
namespace GlobalNamespace {
  ...
  class FingertipReference : public ::UnityEngine::MonoBehaviour {
    ...
    [[deprecated("Use field access instead!")]] ::UnityEngine::GameObject*& dyn_leftIndexFingertip();
    // Get instance field reference: public UnityEngine.GameObject rightIndexFingertip
    [[deprecated("Use field access instead!")]] ::UnityEngine::GameObject*& dyn_rightIndexFingertip();
