...
namespace GlobalNamespace {
  ...
  class PlacedBrickRendererManager::MeshRenderBucket : public ::Il2CppObject {
    ...
    ::System::Collections::Generic::LinkedList_1<::GlobalNamespace::PlacedBrickRendererManager::MeshToRender*>*& dyn_MeshesToRender();
    // Get instance field reference: private PlacedBrickRendererManager/MeshRenderBucketGroup[] _meshRenderBucketGroups
    ::ArrayW<::GlobalNamespace::PlacedBrickRendererManager::MeshRenderBucketGroup*>& dyn__meshRenderBucketGroups();
