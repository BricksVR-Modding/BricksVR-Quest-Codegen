...
namespace System {
  // Forward declaring type: ArithmeticException
...
namespace System {
  ...
  // [ComVisibleAttribute] Offset: 6C6648
  class ArithmeticException : public ::System::SystemException {
    ...
    template<::il2cpp_utils::CreationType creationType = ::il2cpp_utils::CreationType::Temporary>
    static ArithmeticException* New_ctor(::StringW message) {
      static auto ___internal__logger = ::Logger::get().WithContext("::System::ArithmeticException::.ctor");
    ...
    template<::il2cpp_utils::CreationType creationType = ::il2cpp_utils::CreationType::Temporary>
    static ArithmeticException* New_ctor(::StringW message, ::System::Exception* innerException) {
      static auto ___internal__logger = ::Logger::get().WithContext("::System::ArithmeticException::.ctor");
