...
namespace GlobalNamespace {
  ...
  class PCQualitySettings : public ::UnityEngine::MonoBehaviour {
    ...
    [[deprecated("Use field access instead!")]] int& dyn_QualitySetting();
    // Get instance field reference: private System.Int32 shadowDistance
    [[deprecated("Use field access instead!")]] int& dyn_shadowDistance();
    ...
    [[deprecated("Use field access instead!")]] ::UnityEngine::ShadowResolution& dyn_shadowResolution();
    // Get instance field reference: private UnityEngine.ShadowmaskMode shadowMask
    [[deprecated("Use field access instead!")]] ::UnityEngine::ShadowmaskMode& dyn_shadowMask();
