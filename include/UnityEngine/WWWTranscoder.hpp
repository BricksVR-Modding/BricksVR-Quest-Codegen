...
// Il2CppName: SevenBitClean
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (*)(::ArrayW<uint8_t>)>(&UnityEngine::WWWTranscoder::SevenBitClean)> {
  static const MethodInfo* get() {
    static auto* input = &il2cpp_functions::array_class_get(::il2cpp_utils::GetClassFromName("System", "Byte"), 1)->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::WWWTranscoder*), "SevenBitClean", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{input});
  }
};
