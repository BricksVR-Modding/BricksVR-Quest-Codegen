...
namespace GlobalNamespace {
  ...
  class PlacedBrickRenderer : public ::UnityEngine::MonoBehaviour {
    ...
    ::GlobalNamespace::PlacedBrickRendererManagerTwo*& dyn_placedBrickRendererManager();
    // Get instance field reference: private BrickAttach _attach
    ::GlobalNamespace::BrickAttach*& dyn__attach();
