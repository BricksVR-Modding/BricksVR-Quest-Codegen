...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int (*)(::StringW)>(&TMPro::TMP_TextParsingUtilities::GetHashCode)> {
  static const MethodInfo* get() {
...
// Writing MetadataGetter for method: TMPro::TMP_TextParsingUtilities::ConvertToUTF32
// Il2CppName: ConvertToUTF32
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<uint (*)(uint, uint)>(&TMPro::TMP_TextParsingUtilities::ConvertToUTF32)> {
  static const MethodInfo* get() {
