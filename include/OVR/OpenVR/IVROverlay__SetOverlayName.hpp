...
NEED_NO_BOX(::OVR::OpenVR::IVROverlay::_SetOverlayName);
...
namespace OVR::OpenVR {
  ...
  // [UnmanagedFunctionPointerAttribute] Offset: 719304
  class IVROverlay::_SetOverlayName : public ::System::MulticastDelegate {
    ...
    // Offset: 0xE90BEC
    ::System::IAsyncResult* BeginInvoke(uint64_t ulOverlayHandle, ::StringW pchName, ::System::AsyncCallback* callback, ::Il2CppObject* object);
...
// Il2CppName: Invoke
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::OVR::OpenVR::EVROverlayError (OVR::OpenVR::IVROverlay::_SetOverlayName::*)(uint64_t, ::StringW)>(&OVR::OpenVR::IVROverlay::_SetOverlayName::Invoke)> {
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::IAsyncResult* (OVR::OpenVR::IVROverlay::_SetOverlayName::*)(uint64_t, ::StringW, ::System::AsyncCallback*, ::Il2CppObject*)>(&OVR::OpenVR::IVROverlay::_SetOverlayName::BeginInvoke)> {
  static const MethodInfo* get() {
    static auto* ulOverlayHandle = &::il2cpp_utils::GetClassFromName("System", "UInt64")->byval_arg;
    static auto* pchName = &::il2cpp_utils::GetClassFromName("System", "String")->byval_arg;
