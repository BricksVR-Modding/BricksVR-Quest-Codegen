...
namespace Normal::Realtime::Serialization {
  ...
  // [DefaultMemberAttribute] Offset: 715E1C
  template<typename TValue>
  class RealtimeArray_1 : public ::Normal::Realtime::RealtimeModel/*, public ::System::Collections::Generic::IEnumerable_1<TValue>, public ::Normal::Realtime::Serialization::ICollection*/ {
    ...
    class ModelAdded : public ::il2cpp_utils::il2cpp_type_check::NestedType, public ::System::MulticastDelegate {
      ...
      void Invoke(::Normal::Realtime::Serialization::RealtimeArray_1<TValue>* array, TValue model, bool remote) {
        ...
        auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, "Invoke", std::vector<Il2CppClass*>{}, ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractType(array), ::il2cpp_utils::ExtractType(model), ::il2cpp_utils::ExtractType(remote)})));
      ...
      ::System::IAsyncResult* BeginInvoke(::Normal::Realtime::Serialization::RealtimeArray_1<TValue>* array, TValue model, bool remote, ::System::AsyncCallback* callback, ::Il2CppObject* object) {
        ...
        auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, "BeginInvoke", std::vector<Il2CppClass*>{}, ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractType(array), ::il2cpp_utils::ExtractType(model), ::il2cpp_utils::ExtractType(remote), ::il2cpp_utils::ExtractType(callback), ::il2cpp_utils::ExtractType(object)})));
    ...
    class ArrayUpdate : public ::il2cpp_utils::il2cpp_type_check::NestedType, public ::Il2CppObject/*, public ::Normal::Realtime::Serialization::IModel*/ {
      ...
      ::Normal::Realtime::Serialization::RealtimeArray_1<TValue>*& dyn__array() {
      ...
      ::System::Collections::Generic::List_1<TValue>*& dyn_updates() {
    ...
    class $$c__DisplayClass13_0 : public ::il2cpp_utils::il2cpp_type_check::NestedType, public ::Il2CppObject {
      ...
      ::System::Collections::Generic::List_1<TValue>*& dyn_array() {
    ...
    class $GetEnumerator$d__13 : public ::il2cpp_utils::il2cpp_type_check::NestedType, public ::Il2CppObject/*, public ::System::Collections::Generic::IEnumerator_1<TValue>*/ {
      ...
      ::Normal::Realtime::Serialization::RealtimeArray_1<TValue>*& dyn_$$4__this() {
      ...
      typename ::System::Collections::Generic::List_1<TValue>::Enumerator& dyn_$$7__wrap1() {
    ...
    ::System::Collections::Generic::List_1<TValue>*& dyn__storage() {
    ...
    ::Normal::Realtime::Serialization::LocalChangeCache_1<typename ::Normal::Realtime::Serialization::RealtimeArray_1<TValue>::ArrayUpdate*>*& dyn__cache() {
    ...
    typename ::Normal::Realtime::Serialization::RealtimeArray_1<TValue>::ArrayUpdate*& dyn__activelyDeserializingInflightArrayUpdate() {
    ...
    typename ::Normal::Realtime::Serialization::RealtimeArray_1<TValue>::ModelAdded*& dyn_modelAdded() {
