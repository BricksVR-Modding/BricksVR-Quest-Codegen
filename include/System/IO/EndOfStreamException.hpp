...
namespace System::IO {
  // Forward declaring type: EndOfStreamException
...
namespace System::IO {
  ...
  // [ComVisibleAttribute] Offset: 6C8B68
  class EndOfStreamException : public ::System::IO::IOException {
    ...
    template<::il2cpp_utils::CreationType creationType = ::il2cpp_utils::CreationType::Temporary>
    static EndOfStreamException* New_ctor(::StringW message) {
      static auto ___internal__logger = ::Logger::get().WithContext("::System::IO::EndOfStreamException::.ctor");
...
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: System::IO::EndOfStreamException::New_ctor
// Il2CppName: .ctor
