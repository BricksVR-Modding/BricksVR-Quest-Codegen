...
namespace System {
  ...
  // [ClassInterfaceAttribute] Offset: DFCD0
  // [ComVisibleAttribute] Offset: DFCD0
  class AppDomain : public ::System::MarshalByRefObject {
    ...
    // Offset: 0x4694B0
    ::System::Reflection::Assembly* DoResourceResolve(::StringW name, ::System::Reflection::Assembly* requesting);
...
// Writing MetadataGetter for method: System::AppDomain::add_ProcessExit
// Il2CppName: add_ProcessExit
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (System::AppDomain::*)(::System::EventHandler*)>(&System::AppDomain::add_ProcessExit)> {
  static const MethodInfo* get() {
    static auto* value = &::il2cpp_utils::GetClassFromName("System", "EventHandler")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(System::AppDomain*), "add_ProcessExit", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{value});
  }
};
// Writing MetadataGetter for method: System::AppDomain::remove_ProcessExit
// Il2CppName: remove_ProcessExit
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (System::AppDomain::*)(::System::EventHandler*)>(&System::AppDomain::remove_ProcessExit)> {
  static const MethodInfo* get() {
    static auto* value = &::il2cpp_utils::GetClassFromName("System", "EventHandler")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(System::AppDomain*), "remove_ProcessExit", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{value});
  }
};
...
// Writing MetadataGetter for method: System::AppDomain::LoadSatellite
// Il2CppName: LoadSatellite
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Reflection::Assembly* (System::AppDomain::*)(::System::Reflection::AssemblyName*, bool)>(&System::AppDomain::LoadSatellite)> {
  static const MethodInfo* get() {
    static auto* assemblyRef = &::il2cpp_utils::GetClassFromName("System.Reflection", "AssemblyName")->byval_arg;
    static auto* throwOnError = &::il2cpp_utils::GetClassFromName("System", "Boolean")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(System::AppDomain*), "LoadSatellite", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{assemblyRef, throwOnError});
  }
};
...
// Writing MetadataGetter for method: System::AppDomain::GetCurrentThreadId
// Il2CppName: GetCurrentThreadId
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int (*)()>(&System::AppDomain::GetCurrentThreadId)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(System::AppDomain*), "GetCurrentThreadId", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
...
// Writing MetadataGetter for method: System::AppDomain::DoResourceResolve
// Il2CppName: DoResourceResolve
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Reflection::Assembly* (System::AppDomain::*)(::StringW, ::System::Reflection::Assembly*)>(&System::AppDomain::DoResourceResolve)> {
  static const MethodInfo* get() {
    static auto* name = &::il2cpp_utils::GetClassFromName("System", "String")->byval_arg;
    static auto* requesting = &::il2cpp_utils::GetClassFromName("System.Reflection", "Assembly")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(System::AppDomain*), "DoResourceResolve", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{name, requesting});
  }
};
