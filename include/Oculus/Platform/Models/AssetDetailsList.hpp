...
namespace Oculus::Platform::Models {
  ...
  // Autogenerated type: Oculus.Platform.Models.AssetDetailsList
  ...
  class AssetDetailsList : public ::Oculus::Platform::Models::DeserializableList_1<::Oculus::Platform::Models::AssetDetails*> {
    ...
    static AssetDetailsList* New_ctor(::System::IntPtr a) {
      ...
      return THROW_UNLESS((::il2cpp_utils::New<AssetDetailsList*, creationType>(a)));
    }
  }; // Oculus.Platform.Models.AssetDetailsList
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: Oculus::Platform::Models::AssetDetailsList::New_ctor
// Il2CppName: .ctor
