...
namespace Normal::Realtime {
  ...
  class RealtimeViewModel : public ::Normal::Realtime::RealtimeModel {
    ...
    ::System::Collections::Generic::List_1<::Normal::Realtime::RealtimeViewModel::CachedDeltaUpdate>*& dyn__cachedComponentsModelDeltaUpdates();
    // Get instance field reference: private Normal.Realtime.ImmutableModelCollection _childViewsModel
    ::Normal::Realtime::ImmutableModelCollection*& dyn__childViewsModel();
    // Get instance field reference: private Normal.Realtime.Serialization.ReadBuffer _cachedChildViewsModel
    ::Normal::Realtime::Serialization::ReadBuffer*& dyn__cachedChildViewsModel();
    ...
    ::System::Collections::Generic::List_1<::Normal::Realtime::RealtimeViewModel::CachedDeltaUpdate>*& dyn__cachedChildViewsModelDeltaUpdates();
