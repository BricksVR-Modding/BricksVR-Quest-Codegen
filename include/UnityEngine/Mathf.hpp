...
namespace UnityEngine {
  ...
  // [NativeHeaderAttribute] Offset: 6D8620
  // [NativeHeaderAttribute] Offset: 6D8620
  // [NativeHeaderAttribute] Offset: 6D8620
  // [NativeHeaderAttribute] Offset: 6D8620
  struct Mathf/*, public ::System::ValueType*/ {
    ...
    // static public System.Single SmoothDampAngle(System.Single current, System.Single target, ref System.Single currentVelocity, System.Single smoothTime)
    // Offset: 0xCAAA94
    static float SmoothDampAngle(float current, float target, ByRef<float> currentVelocity, float smoothTime);
    // static public System.Single SmoothDampAngle(System.Single current, System.Single target, ref System.Single currentVelocity, System.Single smoothTime, System.Single maxSpeed, System.Single deltaTime)
    // Offset: 0xCAAB38
    static float SmoothDampAngle(float current, float target, ByRef<float> currentVelocity, float smoothTime, float maxSpeed, float deltaTime);
...
// Writing MetadataGetter for method: UnityEngine::Mathf::SmoothDampAngle
// Il2CppName: SmoothDampAngle
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<float (*)(float, float, ByRef<float>, float)>(&UnityEngine::Mathf::SmoothDampAngle)> {
  static const MethodInfo* get() {
    static auto* current = &::il2cpp_utils::GetClassFromName("System", "Single")->byval_arg;
    static auto* target = &::il2cpp_utils::GetClassFromName("System", "Single")->byval_arg;
    static auto* currentVelocity = &::il2cpp_utils::GetClassFromName("System", "Single")->this_arg;
    static auto* smoothTime = &::il2cpp_utils::GetClassFromName("System", "Single")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::Mathf), "SmoothDampAngle", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{current, target, currentVelocity, smoothTime});
  }
};
// Writing MetadataGetter for method: UnityEngine::Mathf::SmoothDampAngle
// Il2CppName: SmoothDampAngle
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<float (*)(float, float, ByRef<float>, float, float, float)>(&UnityEngine::Mathf::SmoothDampAngle)> {
  static const MethodInfo* get() {
    static auto* current = &::il2cpp_utils::GetClassFromName("System", "Single")->byval_arg;
    static auto* target = &::il2cpp_utils::GetClassFromName("System", "Single")->byval_arg;
    static auto* currentVelocity = &::il2cpp_utils::GetClassFromName("System", "Single")->this_arg;
    ...
    static auto* maxSpeed = &::il2cpp_utils::GetClassFromName("System", "Single")->byval_arg;
    static auto* deltaTime = &::il2cpp_utils::GetClassFromName("System", "Single")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::Mathf), "SmoothDampAngle", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{current, target, currentVelocity, smoothTime, maxSpeed, deltaTime});
  }
};
