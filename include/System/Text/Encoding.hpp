...
namespace System::Text {
  ...
  // [ComVisibleAttribute] Offset: 6C782C
  class Encoding : public ::Il2CppObject/*, public ::System::ICloneable*/ {
    ...
    // [OptionalFieldAttribute] Offset: 0x6CDD14
    ...
    char __padding3[0x6] = {};
    // [OptionalFieldAttribute] Offset: 0x6CDD4C
    ...
    // [OptionalFieldAttribute] Offset: 0x6CDD84
    ...
    ::System::Globalization::CodePageDataItem*& dyn_dataItem();
    // Get instance field reference: System.Boolean m_deserializedFromEverett
    bool& dyn_m_deserializedFromEverett();
    ...
    ::System::Text::EncoderFallback*& dyn_encoderFallback();
    // Get instance field reference: System.Text.DecoderFallback decoderFallback
    ::System::Text::DecoderFallback*& dyn_decoderFallback();
    ...
    // public System.String GetString(System.Byte* bytes, System.Int32 byteCount)
    // Offset: 0xC7A278
    ::StringW GetString(uint8_t* bytes, int byteCount);
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (System::Text::Encoding::*)(uint8_t*, int)>(&System::Text::Encoding::GetString)> {
  static const MethodInfo* get() {
    static auto* bytes = &il2cpp_functions::Class_GetPtrClass(::il2cpp_utils::GetClassFromName("System", "Byte"))->byval_arg;
    static auto* byteCount = &::il2cpp_utils::GetClassFromName("System", "Int32")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(System::Text::Encoding*), "GetString", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{bytes, byteCount});
  }
};
