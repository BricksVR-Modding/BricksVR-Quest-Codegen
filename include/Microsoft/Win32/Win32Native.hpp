...
// Writing MetadataGetter for method: Microsoft::Win32::Win32Native::GetCurrentProcessId
// Il2CppName: GetCurrentProcessId
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<uint (*)()>(&Microsoft::Win32::Win32Native::GetCurrentProcessId)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(Microsoft::Win32::Win32Native*), "GetCurrentProcessId", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
