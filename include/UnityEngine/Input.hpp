...
namespace UnityEngine {
  ...
  // [NativeHeaderAttribute] Offset: 6FE66C
  class Input : public ::Il2CppObject {
    ...
    // static public UnityEngine.Touch[] get_touches()
    // Offset: 0x104A430
    static ::ArrayW<::UnityEngine::Touch> get_touches();
...
// Writing MetadataGetter for method: UnityEngine::Input::get_touches
// Il2CppName: get_touches
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayW<::UnityEngine::Touch> (*)()>(&UnityEngine::Input::get_touches)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::Input*), "get_touches", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
