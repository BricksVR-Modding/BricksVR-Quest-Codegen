...
namespace UnityEngine {
  ...
  // [UsedByNativeCodeAttribute] Offset: 6ECF70
  struct UIVertex/*, public ::System::ValueType*/ {
    ...
    ::UnityEngine::Vector4& dyn_tangent();
