...
[[deprecated("Use field access instead!")]] uint& Oculus::Platform::Models::AssetFileDownloadUpdate::dyn_BytesTotal() {
...
[[deprecated("Use field access instead!")]] int& Oculus::Platform::Models::AssetFileDownloadUpdate::dyn_BytesTransferred() {
