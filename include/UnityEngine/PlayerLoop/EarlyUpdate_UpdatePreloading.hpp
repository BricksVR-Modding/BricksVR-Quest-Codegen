...
namespace UnityEngine::PlayerLoop {
  ...
  // Autogenerated type: UnityEngine.PlayerLoop.EarlyUpdate/UnityEngine.PlayerLoop.UpdatePreloading
  // [TokenAttribute] Offset: FFFFFFFF
  // [RequiredByNativeCodeAttribute] Offset: 6D9F54
  struct EarlyUpdate::UpdatePreloading/*, public ::System::ValueType*/ {
    public:
    // Creating value type constructor for type: UpdatePreloading
    constexpr UpdatePreloading() noexcept {}
