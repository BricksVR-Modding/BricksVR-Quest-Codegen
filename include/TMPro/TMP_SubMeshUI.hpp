...
namespace TMPro {
  ...
  class TMP_SubMeshUI : public ::UnityEngine::UI::MaskableGraphic {
    ...
    // private UnityEngine.Transform m_RootCanvasTransform
    // Size: 0x8
    // Offset: 0x118
    ::UnityEngine::Transform* m_RootCanvasTransform;
    // Field size check
    ...
    [[deprecated]] ::TMPro::TextMeshProUGUI*& dyn_m_TextComponent();
    ...
    [[deprecated]] int& dyn_m_materialReferenceIndex();
    // Get instance field reference: private UnityEngine.Transform m_RootCanvasTransform
    [[deprecated]] ::UnityEngine::Transform*& dyn_m_RootCanvasTransform();
  ...
  #pragma pack(pop)
  static check_size<sizeof(TMP_SubMeshUI), 280 + sizeof(::UnityEngine::Transform*)> __TMPro_TMP_SubMeshUISizeCheck;
  static_assert(sizeof(TMP_SubMeshUI) == 0x120);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
...
// Writing MetadataGetter for method: TMPro::TMP_SubMeshUI::get_textComponent
// Il2CppName: get_textComponent
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::TMPro::TMP_Text* (TMPro::TMP_SubMeshUI::*)()>(&TMPro::TMP_SubMeshUI::get_textComponent)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(TMPro::TMP_SubMeshUI*), "get_textComponent", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
...
// Writing MetadataGetter for method: TMPro::TMP_SubMeshUI::GetRootCanvasTransform
// Il2CppName: GetRootCanvasTransform
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Transform* (TMPro::TMP_SubMeshUI::*)()>(&TMPro::TMP_SubMeshUI::GetRootCanvasTransform)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(TMPro::TMP_SubMeshUI*), "GetRootCanvasTransform", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
