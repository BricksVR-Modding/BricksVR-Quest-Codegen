...
namespace GlobalNamespace {
  ...
  class TeleportInputHandlerTouch : public ::GlobalNamespace::TeleportInputHandlerHMD {
    ...
    // Field size check
    static_assert(sizeof(::UnityEngine::Transform*) == 0x8);
    // [TooltipAttribute] Offset: 0x7206B4
    ...
    // [TooltipAttribute] Offset: 0x7206EC
    ...
    // Field size check
    static_assert(sizeof(::GlobalNamespace::OVRInput::Controller) == 0x4);
    // [TooltipAttribute] Offset: 0x720724
    ...
    // [TooltipAttribute] Offset: 0x72075C
