...
namespace UnityEngine::UIElements {
  ...
  #pragma pack(pop)
  static check_size<sizeof(VisualElement), 344 + sizeof(::UnityEngine::UIElements::BaseVisualElementPanel*)> __UnityEngine_UIElements_VisualElementSizeCheck;
  static_assert(sizeof(VisualElement) == 0x160);
