...
namespace UnityEngine::Events {
  // Forward declaring type: InvokableCall`2<T1, T2>
...
namespace UnityEngine::Events {
  ...
  class InvokableCall_2 : public ::UnityEngine::Events::BaseInvokableCall {
    ...
    #endif
    #endif
    // [DebuggerBrowsableAttribute] Offset: 0x6DCA68
    // private UnityEngine.Events.UnityAction`2<T1,T2> Delegate
    // Size: 0x8
    // Offset: 0x0
    ::UnityEngine::Events::UnityAction_2<T1, T2>* Delegate;
    // Field size check
    static_assert(sizeof(::UnityEngine::Events::UnityAction_2<T1, T2>*) == 0x8);
    public:
    ...
    // Get instance field: private UnityEngine.Events.UnityAction`2<T1,T2> Delegate
    ::UnityEngine::Events::UnityAction_2<T1, T2>*& dyn_Delegate() {
      static auto ___internal__logger = ::Logger::get().WithContext("::UnityEngine::Events::InvokableCall_2::dyn_Delegate");
      auto ___internal__instance = this;
      static auto ___internal__field__offset = THROW_UNLESS(il2cpp_utils::FindField(___internal__instance, "Delegate"))->offset;
      return *reinterpret_cast<::UnityEngine::Events::UnityAction_2<T1, T2>**>(reinterpret_cast<char*>(this) + ___internal__field__offset);
    }
    ...
    void add_Delegate(::UnityEngine::Events::UnityAction_2<T1, T2>* value) {
      static auto ___internal__logger = ::Logger::get().WithContext("::UnityEngine::Events::InvokableCall_2::add_Delegate");
    ...
    void remove_Delegate(::UnityEngine::Events::UnityAction_2<T1, T2>* value) {
      static auto ___internal__logger = ::Logger::get().WithContext("::UnityEngine::Events::InvokableCall_2::remove_Delegate");
    ...
    static InvokableCall_2<T1, T2>* New_ctor(::UnityEngine::Events::UnityAction_2<T1, T2>* action) {
      static auto ___internal__logger = ::Logger::get().WithContext("::UnityEngine::Events::InvokableCall_2::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<InvokableCall_2<T1, T2>*, creationType>(action)));
    }
    // public System.Void Invoke(T1 args0, T2 args1)
    // Offset: 0xFFFFFFFF
    void Invoke(T1 args0, T2 args1) {
      static auto ___internal__logger = ::Logger::get().WithContext("::UnityEngine::Events::InvokableCall_2::Invoke");
      static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, "Invoke", std::vector<Il2CppClass*>{}, ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractType(args0), ::il2cpp_utils::ExtractType(args1)})));
      ::il2cpp_utils::RunMethodRethrow<void, false>(this, ___internal__method, args0, args1);
    }
    ...
    static InvokableCall_2<T1, T2>* New_ctor(::Il2CppObject* target, ::System::Reflection::MethodInfo* theFunction) {
      static auto ___internal__logger = ::Logger::get().WithContext("::UnityEngine::Events::InvokableCall_2::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<InvokableCall_2<T1, T2>*, creationType>(target, theFunction)));
    }
    ...
    bool Find(::Il2CppObject* targetObj, ::System::Reflection::MethodInfo* method) {
      static auto ___internal__logger = ::Logger::get().WithContext("::UnityEngine::Events::InvokableCall_2::Find");
  ...
  // Could not write size check! Type: UnityEngine.Events.InvokableCall`2 is generic, or has no fields that are valid for size checks!
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
