...
namespace Normal::Realtime {
  ...
  class Timeline_1 : public ::Il2CppObject {
    ...
    ::Normal::Utility::RingBuffer_1<::Normal::Realtime::TimelineEntry_1<T>*>*& dyn__buffer() {
    ...
    ::Normal::Realtime::TimelineInterpolator_1<T>*& dyn__interpolator() {
    ...
    ::Normal::Realtime::TimelineExtrapolator_1<T>*& dyn__extrapolator() {
