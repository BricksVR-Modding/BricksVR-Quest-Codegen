...
namespace GlobalNamespace {
  ...
  class BrickMeshRecalculator : public ::UnityEngine::MonoBehaviour {
    ...
    [[deprecated]] ::System::Collections::Generic::List_1<::GlobalNamespace::BrickAttach*>*& dyn__attachesToRecalculate();
    // Get instance field reference: private UnityEngine.Collider[] _overlapColliders
    [[deprecated]] ::ArrayW<::UnityEngine::Collider*>& dyn__overlapColliders();
