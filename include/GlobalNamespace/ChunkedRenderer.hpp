...
namespace GlobalNamespace {
  ...
  class ChunkedRenderer : public ::UnityEngine::MonoBehaviour {
    ...
    ::System::Collections::Generic::Dictionary_2<::GlobalNamespace::ChunkedRenderer::Coord, ::GlobalNamespace::ChunkedRenderer::Chunk*>*& dyn__chunkDictionary();
    // Get instance field reference: private readonly System.Collections.Generic.Queue`1<SetConnectorStatesTask> _workQueue
    ::System::Collections::Generic::Queue_1<::GlobalNamespace::SetConnectorStatesTask>*& dyn__workQueue();
