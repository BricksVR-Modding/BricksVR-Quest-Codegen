...
NEED_NO_BOX(::GlobalNamespace::BrickData::$$c__DisplayClass3_0);
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::BrickData::$$c__DisplayClass3_0*, "", "BrickData/<>c__DisplayClass3_0");
// Type namespace: 
namespace GlobalNamespace {
  // Size: 0x18
  #pragma pack(push, 1)
  // Autogenerated type: BrickData/<>c__DisplayClass3_0
  // [TokenAttribute] Offset: FFFFFFFF
  // [CompilerGeneratedAttribute] Offset: FFFFFFFF
  class BrickData::$$c__DisplayClass3_0 : public ::Il2CppObject {
    public:
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (GlobalNamespace::BrickData::$$c__DisplayClass3_0::*)(::GlobalNamespace::BrickData::Brick)>(&GlobalNamespace::BrickData::$$c__DisplayClass3_0::$BrickByPrefabName$b__0)> {
