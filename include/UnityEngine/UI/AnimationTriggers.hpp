...
namespace UnityEngine::UI {
  ...
  class AnimationTriggers : public ::Il2CppObject {
    ...
    #endif
    #endif
    // [FormerlySerializedAsAttribute] Offset: 0x712B30
    ...
    // [FormerlySerializedAsAttribute] Offset: 0x712B7C
    ...
    // Field size check
    static_assert(sizeof(::StringW) == 0x8);
    // [FormerlySerializedAsAttribute] Offset: 0x712BC8
    ...
    // Field size check
    static_assert(sizeof(::StringW) == 0x8);
    // [FormerlySerializedAsAttribute] Offset: 0x712C14
    ...
    // Field size check
    static_assert(sizeof(::StringW) == 0x8);
    // [FormerlySerializedAsAttribute] Offset: 0x712C60
