...
namespace UnityEngine::XR::Interaction::Toolkit {
  ...
  // [CreateAssetMenuAttribute] Offset: 7241D4
  ...
  class XRControllerRecording : public ::UnityEngine::ScriptableObject {
    ...
    #endif
    #endif
    // [TooltipAttribute] Offset: 0x724C74
    ...
    ::System::Collections::Generic::List_1<::UnityEngine::XR::Interaction::Toolkit::XRControllerRecording::Frame>*& dyn_m_Frames();
