...
namespace GlobalNamespace {
  ...
  class TeleportAimVisualLaser : public ::GlobalNamespace::TeleportSupport {
    ...
    #endif
    #endif
    // [TooltipAttribute] Offset: 0x7204FC
