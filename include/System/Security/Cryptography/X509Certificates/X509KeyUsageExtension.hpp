...
namespace System::Security::Cryptography::X509Certificates {
  ...
  #pragma pack(pop)
  static check_size<sizeof(X509KeyUsageExtension), 44 + sizeof(::System::Security::Cryptography::AsnDecodeStatus)> __System_Security_Cryptography_X509Certificates_X509KeyUsageExtensionSizeCheck;
  static_assert(sizeof(X509KeyUsageExtension) == 0x30);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
...
// Il2CppName: ToString
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (System::Security::Cryptography::X509Certificates::X509KeyUsageExtension::*)(bool)>(&System::Security::Cryptography::X509Certificates::X509KeyUsageExtension::ToString)> {
  static const MethodInfo* get() {
