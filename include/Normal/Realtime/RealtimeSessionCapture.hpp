...
namespace Normal::Realtime {
  ...
  // [RequireComponent] Offset: 715C6C
  class RealtimeSessionCapture : public ::UnityEngine::MonoBehaviour {
    ...
    char __padding0[0x4] = {};
    // [HeaderAttribute] Offset: 0x716534
    ...
    ::Normal::Realtime::RealtimeSessionCapture::Mode& dyn__mode();
    // Get instance field reference: private System.String[] _playbackCaptureFiles
    ::ArrayW<::StringW>& dyn__playbackCaptureFiles();
