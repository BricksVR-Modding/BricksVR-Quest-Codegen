...
namespace UnityEngine::XR {
  ...
  // [NativeConditionalAttribute] Offset: CE450
  // [RequiredByNativeCodeAttribute] Offset: CE450
  // [StaticAccessorAttribute] Offset: CE450
  // [NativeHeaderAttribute] Offset: CE450
