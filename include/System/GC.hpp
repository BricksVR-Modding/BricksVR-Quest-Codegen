...
namespace System {
  ...
  class GC : public ::Il2CppObject {
    ...
    // Offset: 0x2E7D40
    static void _cctor();
    // static private System.Void RecordPressure(System.Int64 bytesAllocated)
    // Offset: 0x2E7B80
    ...
    // static public System.Void AddMemoryPressure(System.Int64 bytesAllocated)
    // Offset: 0x2E79F0
    static void AddMemoryPressure(int64_t bytesAllocated);
    // static public System.Void RemoveMemoryPressure(System.Int64 bytesAllocated)
    // Offset: 0x2E7B90
...
// Writing MetadataGetter for method: System::GC::RecordPressure
// Il2CppName: RecordPressure
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)(int64_t)>(&System::GC::RecordPressure)> {
  static const MethodInfo* get() {
    static auto* bytesAllocated = &::il2cpp_utils::GetClassFromName("System", "Int64")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(System::GC*), "RecordPressure", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{bytesAllocated});
  }
};
...
// Writing MetadataGetter for method: System::GC::AddMemoryPressure
// Il2CppName: AddMemoryPressure
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)(int64_t)>(&System::GC::AddMemoryPressure)> {
  static const MethodInfo* get() {
    static auto* bytesAllocated = &::il2cpp_utils::GetClassFromName("System", "Int64")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(System::GC*), "AddMemoryPressure", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{bytesAllocated});
  }
};
// Writing MetadataGetter for method: System::GC::RemoveMemoryPressure
// Il2CppName: RemoveMemoryPressure
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)(int64_t)>(&System::GC::RemoveMemoryPressure)> {
  static const MethodInfo* get() {
    static auto* bytesAllocated = &::il2cpp_utils::GetClassFromName("System", "Int64")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(System::GC*), "RemoveMemoryPressure", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{bytesAllocated});
  }
};
