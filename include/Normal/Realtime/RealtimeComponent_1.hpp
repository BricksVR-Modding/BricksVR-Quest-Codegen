...
namespace Normal::Realtime {
  ...
  class RealtimeComponent_1 : public ::UnityEngine::MonoBehaviour/*, public ::Normal::Realtime::IConfigurableComponent, public ::Normal::Realtime::IRealtimeComponent*/ {
    ...
    [[deprecated("Use field access instead!")]] TModel& dyn_$model$k__BackingField() {
    ...
    ::Normal::Realtime::RealtimeView* get_realtimeView() {
      ...
      auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::ResolveVtableSlot(this, classof(::Normal::Realtime::RealtimeComponent_1<TModel>*), -1));
