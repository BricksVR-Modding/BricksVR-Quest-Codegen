...
namespace GlobalNamespace {
  ...
  // [RealtimeModelAttribute] Offset: 728550
  class HandColorModel : public ::Normal::Realtime::RealtimeModel {
    ...
    #endif
    #endif
    // [RealtimePropertyAttribute] Offset: 0x72A174
    ...
    // Padding between fields: color and: colorDidChange
    char __padding0[0x4] = {};
    ...
    ::GlobalNamespace::HandColorModel::PropertyChangedHandler_1<::UnityEngine::Color>*& dyn_colorDidChange();
    // Get instance field reference: private Normal.Realtime.ReliableProperty`1<UnityEngine.Color> _colorProperty
    ::Normal::Realtime::ReliableProperty_1<::UnityEngine::Color>*& dyn__colorProperty();
