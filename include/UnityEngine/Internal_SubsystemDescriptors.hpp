...
// Writing MetadataGetter for method: UnityEngine::Internal_SubsystemDescriptors::Create
// Il2CppName: Create
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::IntPtr (*)(::System::IntPtr)>(&UnityEngine::Internal_SubsystemDescriptors::Create)> {
  static const MethodInfo* get() {
    static auto* descriptorPtr = &::il2cpp_utils::GetClassFromName("System", "IntPtr")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::Internal_SubsystemDescriptors*), "Create", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{descriptorPtr});
  }
};
// Writing MetadataGetter for method: UnityEngine::Internal_SubsystemDescriptors::GetId
// Il2CppName: GetId
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (*)(::System::IntPtr)>(&UnityEngine::Internal_SubsystemDescriptors::GetId)> {
  static const MethodInfo* get() {
    static auto* descriptorPtr = &::il2cpp_utils::GetClassFromName("System", "IntPtr")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::Internal_SubsystemDescriptors*), "GetId", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{descriptorPtr});
  }
};
