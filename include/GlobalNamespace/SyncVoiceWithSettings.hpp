...
namespace GlobalNamespace {
  ...
  class SyncVoiceWithSettings : public ::UnityEngine::MonoBehaviour {
    ...
    [[deprecated("Use field access instead!")]] bool& dyn__self();
    // Get instance field reference: private System.Boolean _pushToTalkEnabled
    [[deprecated("Use field access instead!")]] bool& dyn__pushToTalkEnabled();
    // Get instance field reference: private System.Boolean _micEnabled
    [[deprecated("Use field access instead!")]] bool& dyn__micEnabled();
    ...
    [[deprecated("Use field access instead!")]] ::Normal::Realtime::RealtimeAvatarVoice*& dyn_realtimeVoice();
