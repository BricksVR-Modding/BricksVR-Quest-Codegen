...
namespace GlobalNamespace {
  ...
  class QuickInteractor : public ::UnityEngine::MonoBehaviour {
    ...
    ::UnityEngine::LayerMask& dyn_interactionMask();
    ...
    ::System::Collections::Generic::Dictionary_2<::UnityEngine::GameObject*, ::GlobalNamespace::QuickInteractable*>*& dyn__hoveredObjects();
    // Get instance field reference: private OVRInput/Button _trigger
    ::GlobalNamespace::OVRInput::Button& dyn__trigger();
    ...
    ::GlobalNamespace::QuickInteractable*& dyn__tempHoveredInteractable();
