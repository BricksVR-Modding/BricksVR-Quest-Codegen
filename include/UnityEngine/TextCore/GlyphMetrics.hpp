...
namespace UnityEngine::TextCore {
  ...
  struct GlyphMetrics/*, public ::System::ValueType, public ::System::IEquatable_1<::UnityEngine::TextCore::GlyphMetrics>*/ {
    public:
    public:
    // [NativeNameAttribute] Offset: 0xC6920
    ...
    // [NativeNameAttribute] Offset: 0xC6A30
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [NativeNameAttribute] Offset: 0xC6B10
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [NativeNameAttribute] Offset: 0xC6C00
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [NativeNameAttribute] Offset: 0xC6CD0
