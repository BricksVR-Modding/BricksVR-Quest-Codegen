...
namespace GlobalNamespace {
  ...
  class PlacedBrickRendererManagerTwo::RendererBufferRecycler : public ::Il2CppObject {
    ...
    [[deprecated("Use field access instead!")]] ::System::Collections::Generic::List_1<::GlobalNamespace::PlacedBrickRendererManagerTwo::RenderQueueGroup*>*& dyn__availableRenderQueueGroups();
