...
namespace OculusSampleFramework {
  ...
  class Interactable : public ::UnityEngine::MonoBehaviour {
    ...
    ::OculusSampleFramework::Interactable::InteractableStateArgsEvent*& dyn_InteractableStateChanged();
    ...
    // public System.Void UpdateCollisionDepth(OculusSampleFramework.InteractableTool interactableTool, OculusSampleFramework.InteractableCollisionDepth oldCollisionDepth, OculusSampleFramework.InteractableCollisionDepth collisionDepth, OculusSampleFramework.InteractableTool collidingTool)
    // Offset: 0xFFFFFFFF
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (OculusSampleFramework::Interactable::*)(::OculusSampleFramework::InteractableTool*, ::OculusSampleFramework::InteractableCollisionDepth, ::OculusSampleFramework::InteractableCollisionDepth, ::OculusSampleFramework::InteractableTool*)>(&OculusSampleFramework::Interactable::UpdateCollisionDepth)> {
  static const MethodInfo* get() {
    ...
    return ::il2cpp_utils::FindMethod(classof(OculusSampleFramework::Interactable*), "UpdateCollisionDepth", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{interactableTool, oldCollisionDepth, collisionDepth, collidingTool});
  }
};
