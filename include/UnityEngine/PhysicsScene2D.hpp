...
namespace UnityEngine {
  ...
  // [NativeHeaderAttribute] Offset: 703CFC
  struct PhysicsScene2D/*, public ::System::ValueType, public ::System::IEquatable_1<::UnityEngine::PhysicsScene2D>*/ {
    ...
    // public System.Int32 Raycast(UnityEngine.Vector2 origin, UnityEngine.Vector2 direction, System.Single distance, UnityEngine.RaycastHit2D[] results, System.Int32 layerMask)
    // Offset: 0x1046138
    int Raycast(::UnityEngine::Vector2 origin, ::UnityEngine::Vector2 direction, float distance, ::ArrayW<::UnityEngine::RaycastHit2D> results, int layerMask);
...
// Il2CppName: Raycast
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int (UnityEngine::PhysicsScene2D::*)(::UnityEngine::Vector2, ::UnityEngine::Vector2, float, ::ArrayW<::UnityEngine::RaycastHit2D>, int)>(&UnityEngine::PhysicsScene2D::Raycast)> {
  static const MethodInfo* get() {
    static auto* origin = &::il2cpp_utils::GetClassFromName("UnityEngine", "Vector2")->byval_arg;
    static auto* direction = &::il2cpp_utils::GetClassFromName("UnityEngine", "Vector2")->byval_arg;
    static auto* distance = &::il2cpp_utils::GetClassFromName("System", "Single")->byval_arg;
    ...
    static auto* layerMask = &::il2cpp_utils::GetClassFromName("System", "Int32")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::PhysicsScene2D), "Raycast", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{origin, direction, distance, results, layerMask});
  }
};
// Writing MetadataGetter for method: UnityEngine::PhysicsScene2D::Raycast
// Il2CppName: Raycast
