...
namespace UnityEngine {
  ...
  // [NativeTypeAttribute] Offset: 6E950C
  // [UsedByNativeCodeAttribute] Offset: 6E950C
  class IntegratedSubsystem : public ::Il2CppObject/*, public ::UnityEngine::ISubsystem*/ {
    ...
    ::UnityEngine::ISubsystemDescriptor*& dyn_m_subsystemDescriptor();
...
// Writing MetadataGetter for method: UnityEngine::IntegratedSubsystem::Internal_IsRunning
// Il2CppName: Internal_IsRunning
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (UnityEngine::IntegratedSubsystem::*)()>(&UnityEngine::IntegratedSubsystem::Internal_IsRunning)> {
  static const MethodInfo* get() {
