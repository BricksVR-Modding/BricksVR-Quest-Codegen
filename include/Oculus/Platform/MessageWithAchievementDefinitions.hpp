...
namespace Oculus::Platform {
  // Forward declaring type: MessageWithAchievementDefinitions
...
namespace Oculus::Platform {
  ...
  class MessageWithAchievementDefinitions : public ::Oculus::Platform::Message_1<::Oculus::Platform::Models::AchievementDefinitionList*> {
    ...
    static MessageWithAchievementDefinitions* New_ctor(::System::IntPtr c_message) {
      static auto ___internal__logger = ::Logger::get().WithContext("::Oculus::Platform::MessageWithAchievementDefinitions::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<MessageWithAchievementDefinitions*, creationType>(c_message)));
    }
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Oculus::Platform::Models::AchievementDefinitionList* (Oculus::Platform::MessageWithAchievementDefinitions::*)(::System::IntPtr)>(&Oculus::Platform::MessageWithAchievementDefinitions::GetDataFromMessage)> {
  static const MethodInfo* get() {
    ...
    return ::il2cpp_utils::FindMethod(classof(Oculus::Platform::MessageWithAchievementDefinitions*), "GetDataFromMessage", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{c_message});
  }
};
