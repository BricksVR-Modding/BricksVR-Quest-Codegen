...
namespace TMPro {
  ...
  // [DebuggerDisplayAttribute] Offset: 7220EC
  struct TMP_CharacterInfo/*, public ::System::ValueType*/ {
    ...
    int& dyn_strikethroughVertexIndex();
    ...
    ::TMPro::HighlightState& dyn_highlightState();
