...
namespace Normal::Realtime {
  ...
  class SessionCaptureFileStream : public ::Il2CppObject {
    ...
    ::Normal::Realtime::SessionCaptureFileStream::Mode& dyn__mode();
    ...
    ::System::IO::Compression::GZipStream*& dyn__gzipStream();
    ...
    uint& dyn__nextUpdateDeltaTimestamp();
