...
namespace Normal::Realtime {
  ...
  // [RequireComponent] Offset: 71F554
  class RealtimeAvatarManager : public ::UnityEngine::MonoBehaviour {
    ...
    #endif
    #endif
    // [FormerlySerializedAsAttribute] Offset: 0x71F6D8
    ...
    ::UnityEngine::GameObject*& dyn__localAvatarPrefab();
    ...
    ::Normal::Realtime::RealtimeAvatar*& dyn_$localAvatar$k__BackingField();
    ...
    ::System::Collections::Generic::Dictionary_2<int, ::Normal::Realtime::RealtimeAvatar*>*& dyn_$avatars$k__BackingField();
    ...
    ::Normal::Realtime::RealtimeAvatarManager::AvatarCreatedDestroyed*& dyn_avatarCreated();
    ...
    ::Normal::Realtime::RealtimeAvatarManager::AvatarCreatedDestroyed*& dyn_avatarDestroyed();
