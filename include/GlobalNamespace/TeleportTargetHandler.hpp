...
namespace GlobalNamespace {
  ...
  class TeleportTargetHandler : public ::GlobalNamespace::TeleportSupport {
    ...
    #endif
    #endif
    // [TooltipAttribute] Offset: 0x72092C
