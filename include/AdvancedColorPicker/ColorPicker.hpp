...
namespace AdvancedColorPicker {
  ...
  class ColorPicker : public ::UnityEngine::MonoBehaviour {
    ...
    ::AdvancedColorPicker::ColorPicker::ColorChangedEvent*& dyn_OnColorChanged();
