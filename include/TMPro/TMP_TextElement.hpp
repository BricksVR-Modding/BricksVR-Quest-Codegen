...
namespace TMPro {
  ...
  class TMP_TextElement : public ::Il2CppObject {
    ...
    // TMPro.TMP_Asset m_TextAsset
    // Size: 0x8
    // Offset: 0x18
    ::TMPro::TMP_Asset* m_TextAsset;
    // Field size check
    static_assert(sizeof(::TMPro::TMP_Asset*) == 0x8);
    ...
    ::TMPro::TMP_Asset*& dyn_m_TextAsset();
    ...
    // public TMPro.TMP_Asset get_textAsset()
    // Offset: 0x818868
    ::TMPro::TMP_Asset* get_textAsset();
    // public System.Void set_textAsset(TMPro.TMP_Asset value)
    // Offset: 0x818870
  ...
  #pragma pack(pop)
  static check_size<sizeof(TMP_TextElement), 44 + sizeof(float)> __TMPro_TMP_TextElementSizeCheck;
  static_assert(sizeof(TMP_TextElement) == 0x30);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
...
// Writing MetadataGetter for method: TMPro::TMP_TextElement::get_textAsset
// Il2CppName: get_textAsset
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::TMPro::TMP_Asset* (TMPro::TMP_TextElement::*)()>(&TMPro::TMP_TextElement::get_textAsset)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(TMPro::TMP_TextElement*), "get_textAsset", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: TMPro::TMP_TextElement::set_textAsset
// Il2CppName: set_textAsset
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (TMPro::TMP_TextElement::*)(::TMPro::TMP_Asset*)>(&TMPro::TMP_TextElement::set_textAsset)> {
  static const MethodInfo* get() {
    static auto* value = &::il2cpp_utils::GetClassFromName("TMPro", "TMP_Asset")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(TMPro::TMP_TextElement*), "set_textAsset", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{value});
  }
};
