...
namespace UnityEngine::XR::Interaction::Toolkit {
  ...
  #pragma pack(pop)
  static check_size<sizeof(XRDirectInteractor), 272 + sizeof(::System::Comparison_1<::UnityEngine::XR::Interaction::Toolkit::XRBaseInteractable*>*)> __UnityEngine_XR_Interaction_Toolkit_XRDirectInteractorSizeCheck;
  static_assert(sizeof(XRDirectInteractor) == 0x118);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
