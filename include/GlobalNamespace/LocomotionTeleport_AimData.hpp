...
namespace GlobalNamespace {
  ...
  class LocomotionTeleport::AimData : public ::Il2CppObject {
    ...
    ::System::Collections::Generic::List_1<::UnityEngine::Vector3>*& dyn_$Points$k__BackingField();
