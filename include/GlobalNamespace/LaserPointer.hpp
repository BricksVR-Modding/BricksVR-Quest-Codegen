...
namespace GlobalNamespace {
  ...
  class LaserPointer : public ::GlobalNamespace::OVRCursor {
    ...
    ::UnityEngine::GameObject*& dyn_cursorVisual();
    ...
    ::UnityEngine::LineRenderer*& dyn_lineRenderer();
