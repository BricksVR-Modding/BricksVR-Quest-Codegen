...
namespace System {
  ...
  // [ComVisibleAttribute] Offset: 6C774C
  // [CLSCompliantAttribute] Offset: 6C774C
...
// Writing MetadataGetter for method: System::UIntPtr::ToUInt32
// Il2CppName: ToUInt32
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<uint (System::UIntPtr::*)()>(&System::UIntPtr::ToUInt32)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(System::UIntPtr), "ToUInt32", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
