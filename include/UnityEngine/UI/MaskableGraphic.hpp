...
namespace UnityEngine::UI {
  ...
  class MaskableGraphic : public ::UnityEngine::UI::Graphic/*, public ::UnityEngine::UI::IMaterialModifier, public ::UnityEngine::UI::IClippable, public ::UnityEngine::UI::IMaskable*/ {
    ...
    // Field size check
    static_assert(sizeof(bool) == 0x1);
    // [EditorBrowsableAttribute] Offset: 0xEBF00
    // [ObsoleteAttribute] Offset: 0xEBF00
    ...
    // [EditorBrowsableAttribute] Offset: 0xEC050
    // [ObsoleteAttribute] Offset: 0xEC050
  ...
  #pragma pack(pop)
  static check_size<sizeof(MaskableGraphic), 192 + sizeof(::ArrayW<::UnityEngine::Vector3>)> __UnityEngine_UI_MaskableGraphicSizeCheck;
  static_assert(sizeof(MaskableGraphic) == 0xC8);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
