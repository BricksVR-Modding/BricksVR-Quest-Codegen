...
namespace System {
  ...
  // [TypeForwardedFromAttribute] Offset: CF0D0
  template<typename T1, typename T2, typename T3, typename T4, typename TResult>
  class Func_5 : public ::System::MulticastDelegate {
    ...
    TResult Invoke(T1 arg1, T2 arg2, T3 arg3, T4 arg4) {
      ...
      auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::ResolveVtableSlot(this, classof(::System::Func_5<T1, T2, T3, T4, TResult>*), -1)));
