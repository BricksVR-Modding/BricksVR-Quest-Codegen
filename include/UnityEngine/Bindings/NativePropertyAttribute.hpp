...
namespace UnityEngine::Bindings {
  ...
  // [AttributeUsageAttribute] Offset: DCA00
  ...
  #pragma pack(pop)
  static check_size<sizeof(NativePropertyAttribute), 32 + sizeof(::UnityEngine::Bindings::TargetType)> __UnityEngine_Bindings_NativePropertyAttributeSizeCheck;
  static_assert(sizeof(NativePropertyAttribute) == 0x24);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
