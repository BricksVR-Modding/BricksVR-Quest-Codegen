...
namespace AdvancedColorPicker {
  ...
  #pragma pack(pop)
  static check_size<sizeof(ColorEyedropperPreview), 240 + sizeof(::ArrayW<::UnityEngine::Color32>)> __AdvancedColorPicker_ColorEyedropperPreviewSizeCheck;
  static_assert(sizeof(ColorEyedropperPreview) == 0xF8);
}
#include "beatsaber-hook/shared/utils/il2cpp-type-check.hpp"
