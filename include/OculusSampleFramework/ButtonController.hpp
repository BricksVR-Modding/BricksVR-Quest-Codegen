...
namespace OculusSampleFramework {
  ...
  class ButtonController : public ::OculusSampleFramework::Interactable {
    ...
    ::System::Collections::Generic::Dictionary_2<::OculusSampleFramework::InteractableTool*, ::OculusSampleFramework::InteractableState>*& dyn__toolToState();
    // public UnityEngine.Vector3 get_LocalButtonDirection()
    // Offset: 0x855214
    ::UnityEngine::Vector3 get_LocalButtonDirection();
    // private System.Void CallEventsOnOldDepth(OculusSampleFramework.InteractableCollisionDepth oldDepth, OculusSampleFramework.InteractableTool collidingTool)
    // Offset: 0x855370
    void CallEventsOnOldDepth(::OculusSampleFramework::InteractableCollisionDepth oldDepth, ::OculusSampleFramework::InteractableTool* collidingTool);
    // private System.Void CallEventsOnNewDepth(OculusSampleFramework.InteractableCollisionDepth newDepth, OculusSampleFramework.InteractableTool collidingTool)
    // Offset: 0x855574
    void CallEventsOnNewDepth(::OculusSampleFramework::InteractableCollisionDepth newDepth, ::OculusSampleFramework::InteractableTool* collidingTool);
    // private System.Void SustainEventsOnDepth(OculusSampleFramework.InteractableCollisionDepth depth, OculusSampleFramework.InteractableTool collidingTool)
    // Offset: 0x8556D4
    void SustainEventsOnDepth(::OculusSampleFramework::InteractableCollisionDepth depth, ::OculusSampleFramework::InteractableTool* collidingTool);
    ...
    void Awake();
    // public override System.Void UpdateCollisionDepth(OculusSampleFramework.InteractableTool interactableTool, OculusSampleFramework.InteractableCollisionDepth oldCollisionDepth, OculusSampleFramework.InteractableCollisionDepth collisionDepth, OculusSampleFramework.InteractableTool collidingTool)
    // Offset: 0x855834
    // Implemented from: OculusSampleFramework.Interactable
    // Base method: System.Void Interactable::UpdateCollisionDepth(OculusSampleFramework.InteractableTool interactableTool, OculusSampleFramework.InteractableCollisionDepth oldCollisionDepth, OculusSampleFramework.InteractableCollisionDepth collisionDepth, OculusSampleFramework.InteractableTool collidingTool)
    void UpdateCollisionDepth(::OculusSampleFramework::InteractableTool* interactableTool, ::OculusSampleFramework::InteractableCollisionDepth oldCollisionDepth, ::OculusSampleFramework::InteractableCollisionDepth collisionDepth, ::OculusSampleFramework::InteractableTool* collidingTool);
...
// Writing MetadataGetter for method: OculusSampleFramework::ButtonController::CallEventsOnOldDepth
// Il2CppName: CallEventsOnOldDepth
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (OculusSampleFramework::ButtonController::*)(::OculusSampleFramework::InteractableCollisionDepth, ::OculusSampleFramework::InteractableTool*)>(&OculusSampleFramework::ButtonController::CallEventsOnOldDepth)> {
  static const MethodInfo* get() {
    ...
    return ::il2cpp_utils::FindMethod(classof(OculusSampleFramework::ButtonController*), "CallEventsOnOldDepth", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{oldDepth, collidingTool});
  }
};
// Writing MetadataGetter for method: OculusSampleFramework::ButtonController::CallEventsOnNewDepth
// Il2CppName: CallEventsOnNewDepth
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (OculusSampleFramework::ButtonController::*)(::OculusSampleFramework::InteractableCollisionDepth, ::OculusSampleFramework::InteractableTool*)>(&OculusSampleFramework::ButtonController::CallEventsOnNewDepth)> {
  static const MethodInfo* get() {
    static auto* newDepth = &::il2cpp_utils::GetClassFromName("OculusSampleFramework", "InteractableCollisionDepth")->byval_arg;
    static auto* collidingTool = &::il2cpp_utils::GetClassFromName("OculusSampleFramework", "InteractableTool")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(OculusSampleFramework::ButtonController*), "CallEventsOnNewDepth", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{newDepth, collidingTool});
  }
};
// Writing MetadataGetter for method: OculusSampleFramework::ButtonController::SustainEventsOnDepth
// Il2CppName: SustainEventsOnDepth
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (OculusSampleFramework::ButtonController::*)(::OculusSampleFramework::InteractableCollisionDepth, ::OculusSampleFramework::InteractableTool*)>(&OculusSampleFramework::ButtonController::SustainEventsOnDepth)> {
  static const MethodInfo* get() {
    static auto* depth = &::il2cpp_utils::GetClassFromName("OculusSampleFramework", "InteractableCollisionDepth")->byval_arg;
    static auto* collidingTool = &::il2cpp_utils::GetClassFromName("OculusSampleFramework", "InteractableTool")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(OculusSampleFramework::ButtonController*), "SustainEventsOnDepth", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{depth, collidingTool});
  }
};
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (OculusSampleFramework::ButtonController::*)(::OculusSampleFramework::InteractableTool*, ::OculusSampleFramework::InteractableCollisionDepth, ::OculusSampleFramework::InteractableCollisionDepth, ::OculusSampleFramework::InteractableTool*)>(&OculusSampleFramework::ButtonController::UpdateCollisionDepth)> {
  static const MethodInfo* get() {
    ...
    static auto* collisionDepth = &::il2cpp_utils::GetClassFromName("OculusSampleFramework", "InteractableCollisionDepth")->byval_arg;
    static auto* collidingTool = &::il2cpp_utils::GetClassFromName("OculusSampleFramework", "InteractableTool")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(OculusSampleFramework::ButtonController*), "UpdateCollisionDepth", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{interactableTool, oldCollisionDepth, collisionDepth, collidingTool});
  }
};
