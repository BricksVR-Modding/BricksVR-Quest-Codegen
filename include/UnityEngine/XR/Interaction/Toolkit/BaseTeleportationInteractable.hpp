...
namespace UnityEngine::XR::Interaction::Toolkit {
  ...
  class BaseTeleportationInteractable : public ::UnityEngine::XR::Interaction::Toolkit::XRBaseInteractable {
    ...
    #endif
    #endif
    // [HeaderAttribute] Offset: 0x725F38
    // [TooltipAttribute] Offset: 0x725F38
    ...
    // [TooltipAttribute] Offset: 0x725FA8
    ...
    // [TooltipAttribute] Offset: 0x725FF4
    ...
    ::UnityEngine::XR::Interaction::Toolkit::TeleportationProvider*& dyn_m_TeleportationProvider();
    // Get instance field reference: protected UnityEngine.XR.Interaction.Toolkit.MatchOrientation m_MatchOrientation
    ::UnityEngine::XR::Interaction::Toolkit::MatchOrientation& dyn_m_MatchOrientation();
    ...
    ::UnityEngine::XR::Interaction::Toolkit::BaseTeleportationInteractable::TeleportTrigger& dyn_m_TeleportTrigger();
