...
namespace Unity::XR::Oculus {
  ...
  struct NativeMethods::UserDefinedSettings/*, public ::System::ValueType*/ {
    ...
    constexpr UserDefinedSettings(uint16_t sharedDepthBuffer_ = {}, uint16_t dashSupport_ = {}, uint16_t stereoRenderingMode_ = {}, uint16_t colorSpace_ = {}, uint16_t lowOverheadMode_ = {}, uint16_t protectedContext_ = {}, uint16_t focusAware_ = {}, uint16_t optimizeBufferDiscards_ = {}, uint16_t phaseSync_ = {}) noexcept : sharedDepthBuffer{sharedDepthBuffer_}, dashSupport{dashSupport_}, stereoRenderingMode{stereoRenderingMode_}, colorSpace{colorSpace_}, lowOverheadMode{lowOverheadMode_}, protectedContext{protectedContext_}, focusAware{focusAware_}, optimizeBufferDiscards{optimizeBufferDiscards_}, phaseSync{phaseSync_} {}
  ...
  #pragma pack(pop)
  static check_size<sizeof(NativeMethods::UserDefinedSettings), 16 + sizeof(uint16_t)> __Unity_XR_Oculus_NativeMethods_UserDefinedSettingsSizeCheck;
  static_assert(sizeof(NativeMethods::UserDefinedSettings) == 0x12);
}
