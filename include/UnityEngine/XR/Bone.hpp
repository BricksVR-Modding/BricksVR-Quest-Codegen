...
namespace UnityEngine::XR {
  ...
  // [StaticAccessorAttribute] Offset: 6EE79C
  // [NativeHeaderAttribute] Offset: 6EE79C
  // [RequiredByNativeCodeAttribute] Offset: 6EE79C
  // [NativeHeaderAttribute] Offset: 6EE79C
  // [NativeHeaderAttribute] Offset: 6EE79C
  // [NativeConditionalAttribute] Offset: 6EE79C
