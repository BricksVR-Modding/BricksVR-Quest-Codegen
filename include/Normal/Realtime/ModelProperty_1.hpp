...
namespace Normal::Realtime {
  ...
  class ModelProperty_1 : public ::Il2CppObject/*, public ::Normal::Realtime::IProperty_1<T>*/ {
    ...
    [[deprecated]] ::Normal::Realtime::Serialization::PropertyHeader& dyn__header() {
    ...
    [[deprecated]] T& dyn_$value$k__BackingField() {
    ...
    [[deprecated]] bool& dyn__isCollectionModel() {
    ...
    [[deprecated]] uint& dyn__collectionTypeID() {
