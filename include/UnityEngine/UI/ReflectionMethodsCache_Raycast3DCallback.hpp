...
NEED_NO_BOX(::UnityEngine::UI::ReflectionMethodsCache::Raycast3DCallback);
...
namespace UnityEngine::UI {
  // Size: 0x70
  #pragma pack(push, 1)
  // Autogenerated type: UnityEngine.UI.ReflectionMethodsCache/UnityEngine.UI.Raycast3DCallback
