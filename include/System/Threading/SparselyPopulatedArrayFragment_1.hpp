...
namespace System::Threading {
  ...
  class SparselyPopulatedArrayFragment_1 : public ::Il2CppObject {
    ...
    [[deprecated("Use field access instead!")]] ::ArrayW<T>& dyn_m_elements() {
    ...
    [[deprecated("Use field access instead!")]] int& dyn_m_freeCount() {
    ...
    [[deprecated("Use field access instead!")]] ::System::Threading::SparselyPopulatedArrayFragment_1<T>*& dyn_m_next() {
    ...
    [[deprecated("Use field access instead!")]] ::System::Threading::SparselyPopulatedArrayFragment_1<T>*& dyn_m_prev() {
