...
NEED_NO_BOX(::OVR::OpenVR::IVRScreenshots::_HookScreenshot);
DEFINE_IL2CPP_ARG_TYPE(::OVR::OpenVR::IVRScreenshots::_HookScreenshot*, "OVR.OpenVR", "IVRScreenshots/_HookScreenshot");
// Type namespace: OVR.OpenVR
namespace OVR::OpenVR {
  // Size: 0x70
  #pragma pack(push, 1)
  // Autogenerated type: OVR.OpenVR.IVRScreenshots/OVR.OpenVR._HookScreenshot
  // [TokenAttribute] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: 719B88
  ...
  }; // OVR.OpenVR.IVRScreenshots/OVR.OpenVR._HookScreenshot
  #pragma pack(pop)
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::OVR::OpenVR::EVRScreenshotError (OVR::OpenVR::IVRScreenshots::_HookScreenshot::*)(ByRef<::ArrayW<::OVR::OpenVR::EVRScreenshotType>>, int)>(&OVR::OpenVR::IVRScreenshots::_HookScreenshot::Invoke)> {
  static const MethodInfo* get() {
    ...
    return ::il2cpp_utils::FindMethod(classof(OVR::OpenVR::IVRScreenshots::_HookScreenshot*), "Invoke", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{pSupportedTypes, numTypes});
  }
};
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::IAsyncResult* (OVR::OpenVR::IVRScreenshots::_HookScreenshot::*)(ByRef<::ArrayW<::OVR::OpenVR::EVRScreenshotType>>, int, ::System::AsyncCallback*, ::Il2CppObject*)>(&OVR::OpenVR::IVRScreenshots::_HookScreenshot::BeginInvoke)> {
  static const MethodInfo* get() {
    ...
    return ::il2cpp_utils::FindMethod(classof(OVR::OpenVR::IVRScreenshots::_HookScreenshot*), "BeginInvoke", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{pSupportedTypes, numTypes, callback, object});
  }
};
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::OVR::OpenVR::EVRScreenshotError (OVR::OpenVR::IVRScreenshots::_HookScreenshot::*)(::System::IAsyncResult*)>(&OVR::OpenVR::IVRScreenshots::_HookScreenshot::EndInvoke)> {
  static const MethodInfo* get() {
    ...
    return ::il2cpp_utils::FindMethod(classof(OVR::OpenVR::IVRScreenshots::_HookScreenshot*), "EndInvoke", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{result});
  }
};
