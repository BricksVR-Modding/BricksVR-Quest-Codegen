...
namespace GlobalNamespace {
  ...
  // [RealtimeModelAttribute] Offset: 7284F4
  class BrickStorePlayerModel : public ::Normal::Realtime::RealtimeModel {
    ...
    #endif
    #endif
    // [RealtimePropertyAttribute] Offset: 0x729F3C
    ...
    ::Normal::Realtime::ReliableProperty_1<int>*& dyn__brickIdProperty();
  ...
  #pragma pack(pop)
  static check_size<sizeof(BrickStorePlayerModel), 144 + sizeof(::Normal::Realtime::ReliableProperty_1<int>*)> __GlobalNamespace_BrickStorePlayerModelSizeCheck;
  static_assert(sizeof(BrickStorePlayerModel) == 0x98);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
