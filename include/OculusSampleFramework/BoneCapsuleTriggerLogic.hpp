...
namespace OculusSampleFramework {
  ...
  class BoneCapsuleTriggerLogic : public ::UnityEngine::MonoBehaviour {
    ...
    ::OculusSampleFramework::InteractableToolTags& dyn_ToolTags();
    ...
    ::System::Collections::Generic::HashSet_1<::OculusSampleFramework::ColliderZone*>*& dyn_CollidersTouchingUs();
    ...
    ::System::Collections::Generic::List_1<::OculusSampleFramework::ColliderZone*>*& dyn__elementsToCleanUp();
