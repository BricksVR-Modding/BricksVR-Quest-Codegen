...
namespace AdvancedColorPicker {
  ...
  #pragma pack(pop)
  static check_size<sizeof(GraphicalColorComponent), 200 + sizeof(::AdvancedColorPicker::ColorPicker*)> __AdvancedColorPicker_GraphicalColorComponentSizeCheck;
  static_assert(sizeof(GraphicalColorComponent) == 0xD0);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
