...
namespace GlobalNamespace {
  ...
  class BrickPickerManager : public ::UnityEngine::MonoBehaviour {
    ...
    struct MenuTab/*, public ::System::ValueType*/ {
      ...
      ::UnityEngine::UI::Button*& dyn_TabButton();
    ...
    // [TupleElementNamesAttribute] Offset: 0x729E7C
    ...
    ::ArrayW<::UnityEngine::XR::Interaction::Toolkit::XRGrabInteractable*>& dyn_sliderInteractbles();
    // Get instance field reference: public UnityEngine.XR.Interaction.Toolkit.XRGrabInteractable categoryInteractable
    ::UnityEngine::XR::Interaction::Toolkit::XRGrabInteractable*& dyn_categoryInteractable();
    // Get instance field reference: private FadeBrickMenu fade
    ::GlobalNamespace::FadeBrickMenu*& dyn_fade();
    ...
    ::System::Collections::Generic::List_1<::System::ValueTuple_2<::GlobalNamespace::BrickPickerBrick*, float>>*& dyn_hoveredBricksThisFrame();
