...
namespace UnityEngine::Playables {
  ...
  // [RequiredByNativeCodeAttribute] Offset: 6DAD30
  struct PlayableOutput/*, public ::System::ValueType, public ::System::IEquatable_1<::UnityEngine::Playables::PlayableOutput>*/ {
    public:
    public:
