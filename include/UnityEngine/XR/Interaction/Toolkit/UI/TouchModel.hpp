...
namespace UnityEngine::XR::Interaction::Toolkit::UI {
  ...
  struct TouchModel/*, public ::System::ValueType*/ {
    ...
    ::UnityEngine::TouchPhase& dyn_m_SelectPhase();
    ...
    ::UnityEngine::XR::Interaction::Toolkit::UI::TouchModel::ImplementationData& dyn_m_ImplementationData();
...
// Writing MetadataGetter for method: UnityEngine::XR::Interaction::Toolkit::UI::TouchModel::set_pointerId
// Il2CppName: set_pointerId
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::XR::Interaction::Toolkit::UI::TouchModel::*)(int)>(&UnityEngine::XR::Interaction::Toolkit::UI::TouchModel::set_pointerId)> {
  static const MethodInfo* get() {
    static auto* value = &::il2cpp_utils::GetClassFromName("System", "Int32")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::XR::Interaction::Toolkit::UI::TouchModel), "set_pointerId", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{value});
  }
};
