...
// Writing MetadataGetter for method: System::Reflection::MonoMethod::GetMethodBody
// Il2CppName: GetMethodBody
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Reflection::MethodBody* (System::Reflection::MonoMethod::*)()>(&System::Reflection::MonoMethod::GetMethodBody)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(System::Reflection::MonoMethod*), "GetMethodBody", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
