...
namespace System::Linq {
  ...
  class Set_1 : public ::Il2CppObject {
    ...
    // Size: 0x8
    // Offset: 0x0
    ::ArrayW<typename ::System::Linq::Set_1<TElement>::Slot> slots;
    // Field size check
    static_assert(sizeof(::ArrayW<typename ::System::Linq::Set_1<TElement>::Slot>) == 0x8);
    ...
    ::ArrayW<typename ::System::Linq::Set_1<TElement>::Slot>& dyn_slots() {
      ...
      return *reinterpret_cast<::ArrayW<typename ::System::Linq::Set_1<TElement>::Slot>*>(reinterpret_cast<char*>(this) + ___internal__field__offset);
    }
    // Autogenerated instance field getter
