...
namespace UnityEngine::XR::Interaction::Toolkit::UI {
  ...
  class TrackedDeviceGraphicRaycaster : public ::UnityEngine::EventSystems::BaseRaycaster {
    ...
    ::ArrayW<::UnityEngine::RaycastHit>& dyn_occlusionHits3D();
    // Get instance field reference: private UnityEngine.RaycastHit2D[] occlusionHits2D
    ::ArrayW<::UnityEngine::RaycastHit2D>& dyn_occlusionHits2D();
    ...
    ::UnityEngine::XR::Interaction::Toolkit::UI::TrackedDeviceGraphicRaycaster::RaycastHitComparer*& dyn_m_raycastHitComparer();
    ...
    ::System::Collections::Generic::List_1<::UnityEngine::XR::Interaction::Toolkit::UI::TrackedDeviceGraphicRaycaster::RaycastHitData>*& dyn_m_RaycastResultsCache();
    // Get instance field reference: private UnityEngine.RaycastHit[] physicsHits
    ::ArrayW<::UnityEngine::RaycastHit>& dyn_physicsHits();
    // Get instance field reference: private UnityEngine.RaycastHit2D[] graphicHits
    ::ArrayW<::UnityEngine::RaycastHit2D>& dyn_graphicHits();
