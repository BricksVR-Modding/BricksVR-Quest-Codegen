...
namespace GlobalNamespace {
  ...
  // [RequireComponent] Offset: 718140
  class OVRRaycaster : public ::UnityEngine::UI::GraphicRaycaster/*, public ::UnityEngine::EventSystems::IPointerEnterHandler*/ {
    ...
    struct RaycastHit/*, public ::System::ValueType*/ {
      ...
      ::UnityEngine::Vector3& dyn_worldPos();
    ...
    #endif
    #endif
    // [TooltipAttribute] Offset: 0x71B3D4
    ...
    ::UnityEngine::GameObject*& dyn_pointer();
    ...
    ::System::Collections::Generic::List_1<::GlobalNamespace::OVRRaycaster::RaycastHit>*& dyn_m_RaycastResults();
