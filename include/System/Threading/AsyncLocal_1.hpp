...
namespace System::Threading {
  ...
  class AsyncLocal_1 : public ::Il2CppObject/*, public ::System::Threading::IAsyncLocal*/ {
    ...
    [[deprecated]] ::System::Action_1<::System::Threading::AsyncLocalValueChangedArgs_1<T>>*& dyn_m_valueChangedHandler() {
    ...
    T get_Value() {
      static auto ___internal__logger = ::Logger::get().WithContext("::System::Threading::AsyncLocal_1::get_Value");
    ...
    void System_Threading_IAsyncLocal_OnValueChanged(::Il2CppObject* previousValueObj, ::Il2CppObject* currentValueObj, bool contextChanged) {
      ...
      auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::ResolveVtableSlot(this, classof(::System::Threading::AsyncLocal_1<T>*), -1));
      ::il2cpp_utils::RunMethodRethrow<void, false>(this, ___internal__method, previousValueObj, currentValueObj, contextChanged);
    }
