...
namespace System::Diagnostics::Tracing {
  // Forward declaring type: EnumUInt64TypeInfo`1<EnumType>
  template<typename EnumType>
  class EnumUInt64TypeInfo_1;
}
...
namespace System::Diagnostics::Tracing {
  ...
  class EnumUInt64TypeInfo_1 : public ::System::Diagnostics::Tracing::TraceLoggingTypeInfo_1<EnumType> {
    ...
    static EnumUInt64TypeInfo_1<EnumType>* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("::System::Diagnostics::Tracing::EnumUInt64TypeInfo_1::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<EnumUInt64TypeInfo_1<EnumType>*, creationType>()));
    }
    ...
    void WriteMetadata(::System::Diagnostics::Tracing::TraceLoggingMetadataCollector* collector, ::StringW name, ::System::Diagnostics::Tracing::EventFieldFormat format) {
      static auto ___internal__logger = ::Logger::get().WithContext("::System::Diagnostics::Tracing::EnumUInt64TypeInfo_1::WriteMetadata");
    ...
    void WriteData(::System::Diagnostics::Tracing::TraceLoggingDataCollector* collector, ByRef<EnumType> value) {
      static auto ___internal__logger = ::Logger::get().WithContext("::System::Diagnostics::Tracing::EnumUInt64TypeInfo_1::WriteData");
    ...
    ::Il2CppObject* GetData(::Il2CppObject* value) {
      static auto ___internal__logger = ::Logger::get().WithContext("::System::Diagnostics::Tracing::EnumUInt64TypeInfo_1::GetData");
      auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::ResolveVtableSlot(this, classof(::System::Diagnostics::Tracing::TraceLoggingTypeInfo*), -1));
  ...
  // Could not write size check! Type: System.Diagnostics.Tracing.EnumUInt64TypeInfo`1 is generic, or has no fields that are valid for size checks!
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
