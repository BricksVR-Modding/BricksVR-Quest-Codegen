...
// Writing MetadataGetter for method: TMPro::TMP_SelectionCaret::UpdateGeometry
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (TMPro::TMP_SelectionCaret::*)()>(&TMPro::TMP_SelectionCaret::UpdateGeometry)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(TMPro::TMP_SelectionCaret*), "UpdateGeometry", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
