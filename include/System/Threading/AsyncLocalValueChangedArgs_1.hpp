...
namespace System::Threading {
  ...
  struct AsyncLocalValueChangedArgs_1/*, public ::System::ValueType*/ {
    ...
    [[deprecated]] T& dyn_$PreviousValue$k__BackingField() {
    ...
    [[deprecated]] T& dyn_$CurrentValue$k__BackingField() {
    ...
    [[deprecated]] bool& dyn_$ThreadContextChanged$k__BackingField() {
