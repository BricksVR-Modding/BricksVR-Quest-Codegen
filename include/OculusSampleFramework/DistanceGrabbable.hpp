...
namespace OculusSampleFramework {
  ...
  class DistanceGrabbable : public ::GlobalNamespace::OVRGrabbable {
    ...
    ::UnityEngine::MaterialPropertyBlock*& dyn_m_mpb();
    ...
    // public System.Void SetColor(UnityEngine.Color focusColor)
    // Offset: 0x856B64
    void SetColor(::UnityEngine::Color focusColor);
...
// Writing MetadataGetter for method: OculusSampleFramework::DistanceGrabbable::SetColor
// Il2CppName: SetColor
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (OculusSampleFramework::DistanceGrabbable::*)(::UnityEngine::Color)>(&OculusSampleFramework::DistanceGrabbable::SetColor)> {
  static const MethodInfo* get() {
    static auto* focusColor = &::il2cpp_utils::GetClassFromName("UnityEngine", "Color")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(OculusSampleFramework::DistanceGrabbable*), "SetColor", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{focusColor});
  }
};
// Writing MetadataGetter for method: OculusSampleFramework::DistanceGrabbable::ClearColor
// Il2CppName: ClearColor
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (OculusSampleFramework::DistanceGrabbable::*)()>(&OculusSampleFramework::DistanceGrabbable::ClearColor)> {
  static const MethodInfo* get() {
