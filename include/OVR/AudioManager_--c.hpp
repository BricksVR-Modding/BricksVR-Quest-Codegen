...
namespace OVR {
  ...
  class AudioManager::$$c : public ::Il2CppObject {
    ...
    static ::System::Predicate_1<::OVR::SoundEmitter*>* _get_$$9__75_1();
    // Set static field: static public System.Predicate`1<OVR.SoundEmitter> <>9__75_1
    static void _set_$$9__75_1(::System::Predicate_1<::OVR::SoundEmitter*>* value);
    ...
    // System.Boolean <FindFreeEmitter>b__75_1(OVR.SoundEmitter item)
    // Offset: 0x735C80
    bool $FindFreeEmitter$b__75_1(::OVR::SoundEmitter* item);
...
// Writing MetadataGetter for method: OVR::AudioManager::$$c::$FindFreeEmitter$b__75_1
// Il2CppName: <FindFreeEmitter>b__75_1
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (OVR::AudioManager::$$c::*)(::OVR::SoundEmitter*)>(&OVR::AudioManager::$$c::$FindFreeEmitter$b__75_1)> {
  static const MethodInfo* get() {
    static auto* item = &::il2cpp_utils::GetClassFromName("OVR", "SoundEmitter")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(OVR::AudioManager::$$c*), "<FindFreeEmitter>b__75_1", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{item});
  }
};
