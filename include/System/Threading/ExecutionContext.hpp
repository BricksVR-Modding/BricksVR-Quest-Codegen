...
// Writing MetadataGetter for method: System::Threading::ExecutionContext::GetLocalValue
// Il2CppName: GetLocalValue
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Il2CppObject* (*)(::System::Threading::IAsyncLocal*)>(&System::Threading::ExecutionContext::GetLocalValue)> {
  static const MethodInfo* get() {
    static auto* local = &::il2cpp_utils::GetClassFromName("System.Threading", "IAsyncLocal")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(System::Threading::ExecutionContext*), "GetLocalValue", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{local});
  }
};
