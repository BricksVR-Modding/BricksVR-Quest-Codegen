...
namespace Normal::Realtime {
  ...
  class SessionCapture : public ::Il2CppObject {
    ...
    ::Normal::Realtime::SessionCapture::Mode& dyn__mode();
    ...
    ::System::Collections::Generic::Dictionary_2<int, ::System::Collections::Generic::Dictionary_2<uint, ::Normal::Realtime::SessionCapture::DeltaUpdate*>*>*& dyn__clientToIncomingReliableUpdatesMap();
    // Get instance field reference: private System.String _primaryPlaybackFilePath
    ::StringW& dyn__primaryPlaybackFilePath();
    ...
    ::Normal::Realtime::SessionCapture::PlaybackStream*& dyn__primaryPlaybackStream();
    ...
    ::System::Collections::Generic::Queue_1<::Normal::Realtime::SessionCapture::DeltaUpdate*>*& dyn__primaryPlaybackDeltaUpdatesToBeProcessed();
    // Get instance field reference: private System.String[] _secondaryPlaybackFilePaths
    ::ArrayW<::StringW>& dyn__secondaryPlaybackFilePaths();
    ...
    ::System::Collections::Generic::Dictionary_2<int, ::Normal::Realtime::SessionCapture::PlaybackStream*>*& dyn__secondaryPlaybackStreams();
    ...
    ::System::Collections::Generic::Queue_1<::Normal::Realtime::SessionCapture::DeltaUpdate*>*& dyn__playbackDeltaUpdates();
