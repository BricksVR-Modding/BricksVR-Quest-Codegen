...
namespace UnityEngine::XR::Interaction::Toolkit {
  ...
  class SnapTurnProvider : public ::UnityEngine::XR::Interaction::Toolkit::LocomotionProvider {
    ...
    // Field size check
    static_assert(sizeof(int) == 0x4);
    // [TooltipAttribute] Offset: 0x725DBC
    ...
    // [TooltipAttribute] Offset: 0x725E08
    ...
    // [TooltipAttribute] Offset: 0x725E54
    ...
    // [TooltipAttribute] Offset: 0x725EA0
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [TooltipAttribute] Offset: 0x725EEC
    ...
    ::UnityEngine::XR::Interaction::Toolkit::SnapTurnProvider::InputAxes& dyn_m_TurnUsage();
