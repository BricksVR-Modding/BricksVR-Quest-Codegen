...
namespace System::Collections::Generic {
  ...
  // [TypeDependencyAttribute] Offset: C0310
  template<typename T>
  class IReadOnlyCollection_1/*, public ::System::Collections::Generic::IEnumerable_1<T>*/ {
    ...
    int get_Count() {
      ...
      auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::ResolveVtableSlot(this, classof(::System::Collections::Generic::IReadOnlyCollection_1<T>*), -1));
