...
namespace System {
  ...
  // [ComVisibleAttribute] Offset: 6C75C0
...
// Writing MetadataGetter for method: System::IntPtr::ToInt32
// Il2CppName: ToInt32
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int (System::IntPtr::*)()>(&System::IntPtr::ToInt32)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(System::IntPtr), "ToInt32", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
