...
namespace UnityEngine {
  // Forward declaring type: MissingReferenceException
...
namespace UnityEngine {
  // Size: 0x88
  #pragma pack(push, 1)
  // Autogenerated type: UnityEngine.MissingReferenceException
  ...
  class MissingReferenceException : public ::System::Exception {
    ...
    static MissingReferenceException* New_ctor() {
      ...
      return THROW_UNLESS((::il2cpp_utils::New<MissingReferenceException*, creationType>()));
    }
    ...
    static MissingReferenceException* New_ctor(::StringW message) {
      static auto ___internal__logger = ::Logger::get().WithContext("::UnityEngine::MissingReferenceException::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<MissingReferenceException*, creationType>(message)));
    }
    ...
    static MissingReferenceException* New_ctor(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context) {
      static auto ___internal__logger = ::Logger::get().WithContext("::UnityEngine::MissingReferenceException::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<MissingReferenceException*, creationType>(info, context)));
    }
  }; // UnityEngine.MissingReferenceException
  #pragma pack(pop)
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: UnityEngine::MissingReferenceException::New_ctor
// Il2CppName: .ctor
