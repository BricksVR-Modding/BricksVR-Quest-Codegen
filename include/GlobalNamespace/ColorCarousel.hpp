...
namespace GlobalNamespace {
  ...
  class ColorCarousel : public ::UnityEngine::MonoBehaviour {
    ...
    char __padding3[0x3] = {};
    // [FormerlySerializedAsAttribute] Offset: 0x72A08C
    ...
    ::UnityEngine::UI::ProceduralImage::ProceduralImage*& dyn_colorImage();
