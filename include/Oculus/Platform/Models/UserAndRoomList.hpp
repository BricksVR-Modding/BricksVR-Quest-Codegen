...
namespace Oculus::Platform::Models {
  ...
  // Autogenerated type: Oculus.Platform.Models.UserAndRoomList
  ...
  class UserAndRoomList : public ::Oculus::Platform::Models::DeserializableList_1<::Oculus::Platform::Models::UserAndRoom*> {
    ...
    static UserAndRoomList* New_ctor(::System::IntPtr a) {
      ...
      return THROW_UNLESS((::il2cpp_utils::New<UserAndRoomList*, creationType>(a)));
    }
  }; // Oculus.Platform.Models.UserAndRoomList
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: Oculus::Platform::Models::UserAndRoomList::New_ctor
// Il2CppName: .ctor
