...
namespace UnityEngine::XR::Interaction::Toolkit {
  ...
  class LocomotionProvider : public ::UnityEngine::MonoBehaviour {
    ...
    #endif
    #endif
    // [TooltipAttribute] Offset: 0x725CB8
