...
namespace GlobalNamespace {
  ...
  class OVRMixedReality : public ::Il2CppObject {
    ...
    // Offset: 0x92B4E4
    static void _cctor();
    // static public System.Void Update(UnityEngine.GameObject parentObject, UnityEngine.Camera mainCamera, OVRManager/CompositionMethod compositionMethod, System.Boolean useDynamicLighting, OVRManager/CameraDevice cameraDevice, OVRManager/DepthQuality depthQuality)
    // Offset: 0x92AA14
    static void Update(::UnityEngine::GameObject* parentObject, ::UnityEngine::Camera* mainCamera, ::GlobalNamespace::OVRManager_CompositionMethod compositionMethod, bool useDynamicLighting, ::GlobalNamespace::OVRManager_CameraDevice cameraDevice, ::GlobalNamespace::OVRManager_DepthQuality depthQuality);
...
// Il2CppName: Update
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)(::UnityEngine::GameObject*, ::UnityEngine::Camera*, ::GlobalNamespace::OVRManager_CompositionMethod, bool, ::GlobalNamespace::OVRManager_CameraDevice, ::GlobalNamespace::OVRManager_DepthQuality)>(&GlobalNamespace::OVRMixedReality::Update)> {
  static const MethodInfo* get() {
    ...
    static auto* compositionMethod = &::il2cpp_utils::GetClassFromName("", "OVRManager/CompositionMethod")->byval_arg;
    ...
    static auto* depthQuality = &::il2cpp_utils::GetClassFromName("", "OVRManager/DepthQuality")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(GlobalNamespace::OVRMixedReality*), "Update", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{parentObject, mainCamera, compositionMethod, useDynamicLighting, cameraDevice, depthQuality});
  }
};
