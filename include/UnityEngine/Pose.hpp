...
namespace UnityEngine {
  ...
  struct Pose/*, public ::System::ValueType, public ::System::IEquatable_1<::UnityEngine::Pose>*/ {
    ...
    // Offset: 0x115B6C0
    static void _cctor();
    // public UnityEngine.Pose GetTransformedBy(UnityEngine.Pose lhs)
    // Offset: 0x115B0A4
...
// Writing MetadataGetter for method: UnityEngine::Pose::get_identity
// Il2CppName: get_identity
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Pose (*)()>(&UnityEngine::Pose::get_identity)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::Pose), "get_identity", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
...
// Writing MetadataGetter for method: UnityEngine::Pose::GetTransformedBy
// Il2CppName: GetTransformedBy
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Pose (UnityEngine::Pose::*)(::UnityEngine::Pose)>(&UnityEngine::Pose::GetTransformedBy)> {
  static const MethodInfo* get() {
    static auto* lhs = &::il2cpp_utils::GetClassFromName("UnityEngine", "Pose")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::Pose), "GetTransformedBy", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{lhs});
  }
};
