...
namespace UnityEngine::XR {
  ...
  // [UsedByNativeCodeAttribute] Offset: 6EE4C8
  struct XRNodeState/*, public ::System::ValueType*/ {
    ...
    // public System.Boolean get_tracked()
    // Offset: 0x10207A0
    bool get_tracked();
...
// Writing MetadataGetter for method: UnityEngine::XR::XRNodeState::get_tracked
// Il2CppName: get_tracked
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (UnityEngine::XR::XRNodeState::*)()>(&UnityEngine::XR::XRNodeState::get_tracked)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::XR::XRNodeState), "get_tracked", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
