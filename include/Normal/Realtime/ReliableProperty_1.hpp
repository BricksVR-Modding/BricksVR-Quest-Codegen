...
namespace Normal::Realtime {
  ...
  class ReliableProperty_1 : public ::Il2CppObject/*, public ::Normal::Realtime::IProperty_1<T>, public ::Normal::Realtime::IConfirmedProperty*/ {
    ...
    ::Normal::Realtime::PropertySerializer_1<T>& dyn_serializer() {
    ...
    ::System::Collections::Generic::IEqualityComparer_1<T>*& dyn_comparer() {
    ...
    ::System::Nullable_1<::Normal::Realtime::Serialization::InflightUpdateSubscription>& dyn__inflight() {
