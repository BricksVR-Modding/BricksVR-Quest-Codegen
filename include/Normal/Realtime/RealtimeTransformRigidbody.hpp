...
namespace Normal::Realtime {
  ...
  class RealtimeTransformRigidbody : public ::Il2CppObject/*, public ::Normal::Realtime::IRealtimeTransformStrategy*/ {
    ...
    ::Normal::Realtime::Timeline_1<::Normal::Realtime::RigidbodyPhysicsBodyFrame>*& dyn__physicsBodyTimeline();
    ...
    ::Normal::Realtime::Timeline_1<::Normal::Realtime::RigidbodyPhysicsStateFrame>*& dyn__physicsStateTimeline();
