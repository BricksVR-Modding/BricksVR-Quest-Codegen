...
namespace System::Globalization {
  ...
  #pragma pack(pop)
  static check_size<sizeof(GregorianCalendar), 32 + sizeof(::System::Globalization::GregorianCalendarTypes)> __System_Globalization_GregorianCalendarSizeCheck;
  static_assert(sizeof(GregorianCalendar) == 0x24);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
