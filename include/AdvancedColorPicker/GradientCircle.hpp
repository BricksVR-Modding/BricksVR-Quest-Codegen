...
namespace AdvancedColorPicker {
  ...
  #pragma pack(pop)
  static check_size<sizeof(GradientCircle), 240 + sizeof(bool)> __AdvancedColorPicker_GradientCircleSizeCheck;
  static_assert(sizeof(GradientCircle) == 0xF1);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
