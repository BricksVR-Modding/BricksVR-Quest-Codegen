...
namespace UnityEngine::XR::Interaction::Toolkit::UI {
  ...
  struct MouseModel/*, public ::System::ValueType*/ {
    ...
    ::UnityEngine::Vector2& dyn_$deltaPosition$k__BackingField();
    ...
    ::UnityEngine::XR::Interaction::Toolkit::UI::MouseButtonModel& dyn_m_LeftButton();
    // Get instance field reference: private UnityEngine.XR.Interaction.Toolkit.UI.MouseButtonModel m_RightButton
    ::UnityEngine::XR::Interaction::Toolkit::UI::MouseButtonModel& dyn_m_RightButton();
    // Get instance field reference: private UnityEngine.XR.Interaction.Toolkit.UI.MouseButtonModel m_MiddleButton
    ::UnityEngine::XR::Interaction::Toolkit::UI::MouseButtonModel& dyn_m_MiddleButton();
    ...
    ::UnityEngine::XR::Interaction::Toolkit::UI::MouseModel::InternalData& dyn_m_InternalData();
...
// Writing MetadataGetter for method: UnityEngine::XR::Interaction::Toolkit::UI::MouseModel::set_pointerId
// Il2CppName: set_pointerId
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::XR::Interaction::Toolkit::UI::MouseModel::*)(int)>(&UnityEngine::XR::Interaction::Toolkit::UI::MouseModel::set_pointerId)> {
  static const MethodInfo* get() {
    static auto* value = &::il2cpp_utils::GetClassFromName("System", "Int32")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::XR::Interaction::Toolkit::UI::MouseModel), "set_pointerId", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{value});
  }
};
