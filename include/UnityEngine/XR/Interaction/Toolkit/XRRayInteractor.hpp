...
namespace UnityEngine::XR::Interaction::Toolkit {
  ...
  // [AddComponentMenu] Offset: 7245EC
  class XRRayInteractor : public ::UnityEngine::XR::Interaction::Toolkit::XRBaseControllerInteractor/*, public ::UnityEngine::XR::Interaction::Toolkit::UI::IUIInteractable*/ {
    public:
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [RangeAttribute] Offset: 0x725B78
    ...
    // Field size check
    static_assert(sizeof(bool) == 0x1);
    // Padding between fields: m_EnableUIInteraction and: m_RaycastHits
    ...
    // private UnityEngine.XR.Interaction.Toolkit.XRRayInteractor/UnityEngine.XR.Interaction.Toolkit.RaycastHitComparer m_RaycastHitComparer
    // Size: 0x8
    // Offset: 0x158
    ...
    // Field size check
    static_assert(sizeof(int) == 0x4);
    // private UnityEngine.Vector3[] m_ControlPoints
    // Size: 0x8
    // Offset: 0x190
    ...
    public:
    // Creating interface conversion operator: operator ::UnityEngine::XR::Interaction::Toolkit::UI::IUIInteractable
    operator ::UnityEngine::XR::Interaction::Toolkit::UI::IUIInteractable() noexcept {
      return *reinterpret_cast<::UnityEngine::XR::Interaction::Toolkit::UI::IUIInteractable*>(this);
    }
    // static field const value: static private System.Single k_DefaultMaxRaycastDistance
    static constexpr const float k_DefaultMaxRaycastDistance = 30;
    ...
    // static field const value: static private System.Single k_DefaultHoverTimeToSelect
    static constexpr const float k_DefaultHoverTimeToSelect = 0.5;
    // Get static field: static private System.Single k_DefaultHoverTimeToSelect
    static float _get_k_DefaultHoverTimeToSelect();
    // Set static field: static private System.Single k_DefaultHoverTimeToSelect
    static void _set_k_DefaultHoverTimeToSelect(float value);
    // static field const value: static private System.Int32 kMaxRaycastHits
    static constexpr const int kMaxRaycastHits = 10;
    // Get static field: static private System.Int32 kMaxRaycastHits
    static int _get_kMaxRaycastHits();
    // Set static field: static private System.Int32 kMaxRaycastHits
    static void _set_kMaxRaycastHits(int value);
    ...
    ::UnityEngine::GameObject*& dyn_eventSystem();
    ...
    ::UnityEngine::XR::Interaction::Toolkit::XRRayInteractor::LineType& dyn_m_LineType();
    ...
    ::UnityEngine::XR::Interaction::Toolkit::XRRayInteractor::HitDetectionType& dyn_m_HitDetectionType();
    ...
    ::UnityEngine::XR::Interaction::Toolkit::XRRayInteractor::RaycastHitComparer*& dyn_m_RaycastHitComparer();
    ...
    // Offset: 0xFE0984
    float get_Angle();
    // private UnityEngine.Transform get_m_StartTransform()
    // Offset: 0xFE0B80
    ::UnityEngine::Transform* get_m_StartTransform();
    ...
    // public System.Boolean GetLinePoints(ref UnityEngine.Vector3[] linePoints, ref System.Int32 noPoints)
    // Offset: 0xFE0EA0
    bool GetLinePoints(ByRef<::ArrayW<::UnityEngine::Vector3>> linePoints, ByRef<int> noPoints);
    // public System.Boolean TryGetHitInfo(ref UnityEngine.Vector3 position, ref UnityEngine.Vector3 normal, ref System.Int32 positionInLine, ref System.Boolean isValidTarget)
    // Offset: 0xFE0F8C
    ...
    // private UnityEngine.Vector3 CalculateBezierPoint(System.Single t, UnityEngine.Vector3 start, UnityEngine.Vector3 control, UnityEngine.Vector3 end)
    // Offset: 0xFE1848
    ::UnityEngine::Vector3 CalculateBezierPoint(float t, ::UnityEngine::Vector3 start, ::UnityEngine::Vector3 control, ::UnityEngine::Vector3 end);
    // private UnityEngine.Vector3 CalculateProjectilePoint(System.Single t, UnityEngine.Vector3 start, UnityEngine.Vector3 velocity, UnityEngine.Vector3 acceleration)
    // Offset: 0xFE19C8
    ::UnityEngine::Vector3 CalculateProjectilePoint(float t, ::UnityEngine::Vector3 start, ::UnityEngine::Vector3 velocity, ::UnityEngine::Vector3 acceleration);
  ...
  #pragma pack(pop)
  static check_size<sizeof(XRRayInteractor), 408 + sizeof(::UnityEngine::XR::Interaction::Toolkit::UI::XRUIInputModule*)> __UnityEngine_XR_Interaction_Toolkit_XRRayInteractorSizeCheck;
  static_assert(sizeof(XRRayInteractor) == 0x1A0);
}
#include "beatsaber-hook/shared/utils/il2cpp-type-check.hpp"
...
// Writing MetadataGetter for method: UnityEngine::XR::Interaction::Toolkit::XRRayInteractor::get_m_StartTransform
// Il2CppName: get_m_StartTransform
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Transform* (UnityEngine::XR::Interaction::Toolkit::XRRayInteractor::*)()>(&UnityEngine::XR::Interaction::Toolkit::XRRayInteractor::get_m_StartTransform)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::XR::Interaction::Toolkit::XRRayInteractor*), "get_m_StartTransform", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (UnityEngine::XR::Interaction::Toolkit::XRRayInteractor::*)(ByRef<::ArrayW<::UnityEngine::Vector3>>, ByRef<int>)>(&UnityEngine::XR::Interaction::Toolkit::XRRayInteractor::GetLinePoints)> {
  static const MethodInfo* get() {
    ...
    static auto* noPoints = &::il2cpp_utils::GetClassFromName("System", "Int32")->this_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::XR::Interaction::Toolkit::XRRayInteractor*), "GetLinePoints", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{linePoints, noPoints});
  }
};
...
// Writing MetadataGetter for method: UnityEngine::XR::Interaction::Toolkit::XRRayInteractor::UpdateControlPoints
// Il2CppName: UpdateControlPoints
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::XR::Interaction::Toolkit::XRRayInteractor::*)()>(&UnityEngine::XR::Interaction::Toolkit::XRRayInteractor::UpdateControlPoints)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::XR::Interaction::Toolkit::XRRayInteractor*), "UpdateControlPoints", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Vector3 (UnityEngine::XR::Interaction::Toolkit::XRRayInteractor::*)(float, ::UnityEngine::Vector3, ::UnityEngine::Vector3, ::UnityEngine::Vector3)>(&UnityEngine::XR::Interaction::Toolkit::XRRayInteractor::CalculateBezierPoint)> {
  static const MethodInfo* get() {
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Vector3 (UnityEngine::XR::Interaction::Toolkit::XRRayInteractor::*)(float, ::UnityEngine::Vector3, ::UnityEngine::Vector3, ::UnityEngine::Vector3)>(&UnityEngine::XR::Interaction::Toolkit::XRRayInteractor::CalculateProjectilePoint)> {
  static const MethodInfo* get() {
    static auto* t = &::il2cpp_utils::GetClassFromName("System", "Single")->byval_arg;
    static auto* start = &::il2cpp_utils::GetClassFromName("UnityEngine", "Vector3")->byval_arg;
