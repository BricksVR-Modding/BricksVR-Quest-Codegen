...
namespace GlobalNamespace {
  ...
  class OVRGazePointer : public ::GlobalNamespace::OVRCursor {
    ...
    // [TooltipAttribute] Offset: 0xC5AE0
    ...
    char __padding1[0x3] = {};
    // [TooltipAttribute] Offset: 0xC5B40
    ...
    // [TooltipAttribute] Offset: 0xC5BF0
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [TooltipAttribute] Offset: 0xC5C90
    ...
    char __padding4[0x3] = {};
    // [TooltipAttribute] Offset: 0xC5D30
