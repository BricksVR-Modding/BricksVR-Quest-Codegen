...
namespace Normal::Realtime::Serialization {
  ...
  class StreamEventDispatcher : public ::Il2CppObject {
    ...
    ::System::Collections::Generic::Dictionary_2<uint, ::System::Collections::Generic::HashSet_1<::Normal::Realtime::Serialization::StreamEventDispatcher::StreamUpdateCallback*>*>*& dyn__storage();
    // Get instance field reference: private System.Boolean _mutationLock
    bool& dyn__mutationLock();
