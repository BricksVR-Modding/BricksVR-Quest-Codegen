...
namespace GlobalNamespace {
  ...
  class DownloadBricksOnLoad : public ::UnityEngine::MonoBehaviour {
    ...
    ::System::Collections::Generic::List_1<::GlobalNamespace::NormcoreRPC::Brick*>*& dyn_bricksParentedToHeads();
