...
namespace UnityEngine::TextCore::LowLevel {
  ...
  class FontEngine : public ::Il2CppObject {
    ...
    // static UnityEngine.TextCore.LowLevel.GlyphPairAdjustmentRecord[] GetGlyphPairAdjustmentRecords(System.Collections.Generic.List`1<System.UInt32> glyphIndexes, out System.Int32 recordCount)
    // Offset: 0x1033AB4
    static ::ArrayW<::UnityEngine::TextCore::LowLevel::GlyphPairAdjustmentRecord> GetGlyphPairAdjustmentRecords(::System::Collections::Generic::List_1<uint>* glyphIndexes, ByRef<int> recordCount);
    ...
    // static private System.Void GenericListToMarshallingArray(ref System.Collections.Generic.List`1<T> srcList, ref T[] dstArray)
    // Offset: 0xFFFFFFFF
    template<class T>
    static void GenericListToMarshallingArray(ByRef<::System::Collections::Generic::List_1<T>*> srcList, ByRef<::ArrayW<T>> dstArray) {
      static auto ___internal__logger = ::Logger::get().WithContext("::UnityEngine::TextCore::LowLevel::FontEngine::GenericListToMarshallingArray");
      static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod("UnityEngine.TextCore.LowLevel", "FontEngine", "GenericListToMarshallingArray", std::vector<Il2CppClass*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get()}, ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractType(srcList), ::il2cpp_utils::ExtractType(dstArray)})));
      static auto* ___generic__method = THROW_UNLESS(::il2cpp_utils::MakeGenericMethod(___internal__method, std::vector<Il2CppClass*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get()}));
      ::il2cpp_utils::RunMethodRethrow<void, false>(static_cast<Il2CppObject*>(nullptr), ___generic__method, byref(srcList), byref(dstArray));
    }
...
// Writing MetadataGetter for method: UnityEngine::TextCore::LowLevel::FontEngine::GetGlyphPairAdjustmentRecords
// Il2CppName: GetGlyphPairAdjustmentRecords
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayW<::UnityEngine::TextCore::LowLevel::GlyphPairAdjustmentRecord> (*)(::System::Collections::Generic::List_1<uint>*, ByRef<int>)>(&UnityEngine::TextCore::LowLevel::FontEngine::GetGlyphPairAdjustmentRecords)> {
  static const MethodInfo* get() {
    static auto* glyphIndexes = &::il2cpp_utils::MakeGeneric(::il2cpp_utils::GetClassFromName("System.Collections.Generic", "List`1"), ::std::vector<const Il2CppClass*>{::il2cpp_utils::GetClassFromName("System", "UInt32")})->byval_arg;
    static auto* recordCount = &::il2cpp_utils::GetClassFromName("System", "Int32")->this_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::TextCore::LowLevel::FontEngine*), "GetGlyphPairAdjustmentRecords", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{glyphIndexes, recordCount});
  }
};
...
// Writing MetadataGetter for method: UnityEngine::TextCore::LowLevel::FontEngine::GenericListToMarshallingArray
// Il2CppName: GenericListToMarshallingArray
